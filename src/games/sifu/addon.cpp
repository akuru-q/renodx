...
{renodx::templates::settings::CreateDefaultSettings({
  ...
  //{"SceneGradeSaturationCorrection", {.binding =  &shader_injection.scene_grade_saturation_correction}},
  //{"SceneGradeHueCorrection", {.binding =  &shader_injection.scene_grade_hue_correction}},
  //{"SceneGradeBlowoutRestoration", {.binding =  &shader_injection.scene_grade_blowout_restoration}},
...
}),
{
    ...
    new renodx::utils::settings::Setting{
        .key = "CustomToneMapStart",
        .binding = &shader_injection.custom_tonemap_start,
        .default_value = 50.f,
        .label = "Tonemap Shoulder",
        .section = "Tone Mapping",
        .max = 100.f,
        .parse = [](float value) { return value * 0.01f; },
    },
    new renodx::utils::settings::Setting{
        .key = "CustomHDRBoostPower",
        .binding = &shader_injection.custom_hdr_boost_power,
        .default_value = 33.f,
...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX - SIFU";
