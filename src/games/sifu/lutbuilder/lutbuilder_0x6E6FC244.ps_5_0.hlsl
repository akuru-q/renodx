...
// ---- Created with 3Dmigoto v1.3.16 on Thu Apr 23 19:12:27 2026
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.xyz = cb0[44].yyy * float3(0.000154118257,0.00084242021,4.22806261e-005) + float3(0.860117733,1,0.317398727);
  r0.w = cb0[44].y * cb0[44].y;
  r2.xyz = r0.www * float3(1.28641219e-007,7.08145137e-007,4.20481676e-008) + r2.xyz;
  r2.x = r2.x / r2.y;
  r1.z = -cb0[44].y * 2.8974182e-005 + 1;
  ...
  r3.xyz = cb0[39].xxx * r3.xyz;
  r0.xyz = cb0[38].xxx * r0.xyz + r3.xyz;
  r3.xyz = t1.Sample(s1_s, r2.xz).xyz;
  r4.xyz = t1.Sample(s1_s, r2.yw).xyz;
  r4.xyz = r4.xyz + -r3.xyz;
  r3.xyz = r0.www * r4.xyz + r3.xyz;
  r0.xyz = cb0[40].xxx * r3.xyz + r0.xyz;
  r3.xyz = t2.Sample(s2_s, r2.xz).xyz;
  r4.xyz = t2.Sample(s2_s, r2.yw).xyz;
  r4.xyz = r4.xyz + -r3.xyz;
  r3.xyz = r0.www * r4.xyz + r3.xyz;
  r0.xyz = cb0[41].xxx * r3.xyz + r0.xyz;
  r3.xyz = t3.Sample(s3_s, r2.xz).xyz;
  r2.xyz = t3.Sample(s3_s, r2.yw).xyz;
  r2.xyz = r2.xyz + -r3.xyz;
  r2.xyz = r0.www * r2.xyz + r3.xyz;
  r0.xyz = cb0[42].xxx * r2.xyz + r0.xyz;
