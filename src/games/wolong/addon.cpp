...
renodx::utils::settings::Settings settings = {
    ...
    new renodx::utils::settings::Setting{
        ...
        .label = "In-game HDR has to be turned on! The mod should overwrite any of the settings in the HDR calibration menu.",
...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX for Wo Long: Fallen Dynasty";
