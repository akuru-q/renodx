...
renodx::mods::shader::CustomShaders custom_shaders = {
    ...
    CustomShaderEntry(0x8C3DC6EE), // lutsample 2
};
...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX for Fate/Samurai Remnant";
