  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.x = cb9[2].w * -2 + 1;
  r0.xy = v0.xy * r0.xx + cb9[2].ww;
  r0.x = t0.Sample(s0_s, r0.xy).x;
  r0.w = cb9[3].w * -2 + 1;
  r1.xy = v0.xy * r0.ww + cb9[3].ww;
  r0.y = t0.Sample(s0_s, r1.xy).y;
  r0.w = cb9[4].w * -2 + 1;
  ...
  r1.y = dot(float3(-0.168740004,-0.331259996,0.5), r0.xyz);
  r1.z = dot(float3(0.5,-0.418689996,-0.0813099965), r0.xyz);
  ...
  r1.xw = cb9[0].zw + r3.xy;
  r0.w = 1 + r1.x;
  r0.yz = r1.yz * r0.ww;
  r1.x = dot(float2(1,1.40199995), r0.xz);
  r1.y = dot(float3(1,-0.344139993,-0.714139998), r0.xyz);
  r1.z = dot(float2(1,1.77199996), r0.xy);
  r0.x = r1.w * -2 + 1;
  r0.x = 1 / r0.x;
  r0.xyz = saturate(r1.xyz * r0.xxx + -r1.www);
  r0.xyz = log2(r0.xyz);
