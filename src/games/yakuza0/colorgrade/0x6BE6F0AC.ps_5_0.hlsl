  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xyz = log2(r0.xyz);
  r2.x = dot(cb9[5].xyz, r1.xyz);
  r2.y = dot(cb9[9].xyz, r1.xyz);
  r2.z = dot(cb9[13].xyz, r1.xyz);
  ...
  r3.xyz = -cb9[10].xyz * r1.yyy + float3(1,1,1);
  r2.xyz = r3.xyz * r2.xyz;
  r3.xyz = -cb9[14].xyz * r1.zzz + float3(1,1,1);
  r2.xyz = r3.xyz * r2.xyz;
  r0.xyz = saturate(r2.xyz * r0.xyz);
  r2.xyz = cb9[11].xyz * r1.yyy;
  r1.xyw = cb9[7].xyz * r1.xxx + r2.xyz;
  r1.xyz = cb9[15].xyz * r1.zzz + r1.xyw;
