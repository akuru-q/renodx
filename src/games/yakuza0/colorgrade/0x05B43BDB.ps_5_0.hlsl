  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.w = 1 + r1.x;
  r2.y = dot(float3(-0.168740004,-0.331259996,0.5), r0.xyz);
  r2.z = dot(float3(0.5,-0.418689996,-0.0813099965), r0.xyz);
  r0.x = dot(float3(0.298999995,0.587000012,0.114), r0.xyz);
  r0.x = cb9[0].y + r0.x;
  r0.yz = r2.yz * r0.ww;
  r2.x = dot(float2(1,1.40199995), r0.xz);
  r2.y = dot(float3(1,-0.344139993,-0.714139998), r0.xyz);
  r2.z = dot(float2(1,1.77199996), r0.xy);
  r0.x = r1.y * -2 + 1;
  r0.x = 1 / r0.x;
  o0.xyz = saturate(r2.xyz * r0.xxx + -r1.yyy);
  o0.w = 1;
