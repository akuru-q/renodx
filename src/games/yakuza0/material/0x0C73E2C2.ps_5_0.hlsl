  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.w = saturate(dot(r4.yzw, -cb3[6].xyz));
  r3.w = saturate(dot(r4.yzw, -cb3[7].xyz));
  ...
  r1.w = saturate(dot(-r10.xyz, r4.yzw));
  r2.w = saturate(dot(-r5.xyz, r4.yzw));
  r5.x = log2(r1.w);
  r5.y = log2(r2.w);
  r4.yz = cb7[10].ww * r5.xy;
  r4.yz = exp2(r4.yz);
  r5.xyz = cb3[0].xyz * r4.yyy;
  r10.xyz = cb3[1].xyz * r4.zzz;
  r10.xyz = r10.xyz * r3.www;
  r2.xyz = r5.xyz * r2.xyz + r10.xyz;
  r5.xyz = cb6[1].xyz * cb7[10].xyz;
  r2.xyz = r5.xyz * r2.xyz;
  r4.yzw = v7.xyz * r4.zzz;
