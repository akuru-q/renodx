  ...
  out float4 o0 : SV_Target0)
{
  ...
  r7.xyw = v2.xyz * r3.yzw;
  r7.xyz = r7.xyw * r7.zzz;
  r9.xyz = r2.yzw * r3.yzw;
  r10.xyz = r2.yzw * cb1[11].xxx + cb1[11].yyy;
  r3.yzw = r3.yzw * cb1[11].zzz + cb1[11].www;
  r3.yzw = r10.xyz * r3.yzw;
  r3.yzw = r6.zzz ? r3.yzw : r9.xyz;
  r8.xyz = r8.xyz * r6.yyy + v6.xyz;
  r9.xyz = r8.www * r6.yyy + v7.xyz;
  ...
  r6.x = log2(r1.w);
  r6.y = log2(r1.y);
  r1.yw = cb7[10].ww * r6.xy;
  r1.yw = exp2(r1.yw);
  r5.w = cb3[11].x + cb3[11].x;
  r10.xyz = cb3[0].xyz * r1.yyy;
  r11.xyz = cb3[1].xyz * r1.www;
  r11.xyz = r11.xyz * r5.www;
  r11.xyz = r11.xyz * r4.www;
  r2.yzw = r10.xyz * r2.yzw + r11.xyz;
  r10.xyz = cb6[1].xyz * cb7[10].xyz;
  r2.yzw = r10.xyz * r2.yzw;
  r9.xyz = r9.xyz * r1.www;
  r3.yzw = r9.xyz * r3.yzw;
  r3.yzw = r3.yzw * r3.xxx;
  r2.yzw = r2.yzw * r7.xyz + r3.yzw;
  r1.xyw = r2.yzw * r1.xxx;
  r1.xyw = r8.xyz * r0.xyz + r1.xyw;
  r1.z = saturate(r1.z * r2.x + 0.100000001);
