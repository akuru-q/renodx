  ...
  out float4 o0 : SV_Target0)
{
  ...
  r8.xyz = v5.xyz * r2.xxx + cb3[6].xyz;
  r3.w = dot(r8.xyz, r8.xyz);
  r3.w = rsqrt(r3.w);
  r8.xyz = r8.xyz * r3.www;
  r3.w = saturate(dot(-r8.xyz, r1.xyw));
  r8.xyz = v5.xyz * r2.xxx + float3(0,-0.300000012,0);
  r2.x = dot(r8.xyz, r8.xyz);
  r2.x = rsqrt(r2.x);
  r8.xyz = r8.xyz * r2.xxx;
  r1.x = saturate(dot(-r8.xyz, r1.xyw));
  r8.x = log2(r3.w);
  r8.y = log2(r1.x);
  r1.xy = cb7[10].ww * r8.xy;
  r1.xy = exp2(r1.xy);
  r1.w = cb3[11].x + cb3[11].x;
  r8.xyz = cb3[0].xyz * r1.xxx;
  r9.xyz = cb3[1].xyz * r1.yyy;
  r9.xyz = r9.xyz * r1.www;
  r9.xyz = r9.xyz * r4.xxx;
  r2.xyz = r8.xyz * r2.yzw + r9.xyz;
  r8.xyz = cb6[1].xyz * cb7[10].xyz;
  r2.xyz = r8.xyz * r2.xyz;
  r1.xyw = r7.xyz * r1.yyy;
