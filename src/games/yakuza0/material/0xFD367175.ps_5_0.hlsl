  ...
  out float4 o0 : SV_Target0)
{
  ...
  r12.xy = r12.xy * r0.zz;
  r12.xy = exp2(r12.xy);
  r11.xyz = r12.yyy * r11.xyz;
  r9.xyz = r9.xyz * r12.xxx + r11.xyz;
  ...
  r11.xyzw = t14.Sample(s14_s, r8.xy).xyzw;
  ...
  r10.xyz = cb3[0].xyz * r5.yyy;
  r11.xyz = cb3[1].xyz * r5.zzz;
  r12.xyz = r10.xyz * r0.www + r11.xyz;
  r12.xyz = r12.xyz + r3.xyz;
  r12.xyz = r12.xyz + r7.xzw;
  r14.xyz = r12.xyz * r0.yyy;
  r0.z = r5.y * r0.w;
  r0.w = 1 + -r0.y;
  r0.z = r0.z * r0.w + r0.y;
  r5.xyz = r12.xyz * r0.zzz;
  r5.xyz = r13.yyy ? r5.xyz : r14.xyz;
  r4.xyz = r6.xyz * r4.yzw + r9.xyz;
  ...
  r3.xyz = cb9[15].xxx * r6.xyz;
  r0.yzw = r3.xyz * r4.xyz + r0.yzw;
  r3.xyz = cb9[15].yyy * r6.xyz;
  r0.yzw = r3.xyz * r4.xyz + r0.yzw;
