  ...
  out float4 o0 : SV_Target0)
{
  ...
  r4.w = r6.x * r6.y;
  r3.yzw = r4.www * r3.yzw + cb3[5].xyz;
  r7.xyw = v2.xyz * r4.xyz;
  r7.xyz = r7.xyw * r7.zzz;
  r9.xyz = r3.yzw * r4.xyz;
  r10.xyz = r3.yzw * cb1[11].xxx + cb1[11].yyy;
  r11.xyz = r4.xyz * cb1[11].zzz + cb1[11].www;
  r10.xyz = r11.xyz * r10.xyz;
  r9.xyz = r6.zzz ? r10.xyz : r9.xyz;
  r4.w = saturate(dot(r1.xyw, -cb3[6].xyz));
  r5.w = saturate(dot(r1.xyw, -cb3[7].xyz));
  r10.xyz = cb3[0].xyz * r4.www;
  r11.xyz = cb3[1].xyz * r5.www;
  r12.xyz = cb6[0].xyz * cb7[9].xyz;
  r11.xyz = r11.xyz * r6.yyy;
  r10.xyz = r10.xyz * r3.yzw + r11.xyz;
  ...
  r11.xyz = v5.xyz * r3.xxx + cb3[6].xyz;
  r3.x = dot(r11.xyz, r11.xyz);
  r3.x = rsqrt(r3.x);
  r11.xyz = r11.xyz * r3.xxx;
  r3.x = saturate(dot(-r11.xyz, r1.xyw));
  r4.w = saturate(dot(-r5.xyz, r1.xyw));
  r11.x = log2(r3.x);
  r11.y = log2(r4.w);
  ...
  r1.z = dot(r5.xyz, r1.xyw);
  r1.z = r1.z + r1.z;
  r1.xyz = r1.xyw * -r1.zzz + r5.xyz;
  r1.xyz = float3(-1,1,1) * r1.xyz;
  r1.xyzw = t2.Sample(s2_s, r1.xyz).xyzw;
