  ...
  out float4 o0 : SV_Target0)
{
  ...
  r3.xyz = v8.xyz * r1.xxx;
  r2.yzw = r1.yyy * r2.yzw + r3.xyz;
  ...
  r1.w = r5.x * r5.y;
  r7.xyw = r1.www * r8.xyz + cb3[5].xyz;
  ...
  r1.w = saturate(dot(r3.xyz, -cb3[7].xyz));
  r3.w = saturate(r2.w);
  ...
  r19.xyz = v5.xyz * r1.yyy + cb3[6].xyz;
  r3.w = dot(r19.xyz, r19.xyz);
  r3.w = rsqrt(r3.w);
  r19.xyz = r19.xyz * r3.www;
  r3.w = saturate(dot(-r19.xyz, r3.xyz));
  r19.xyz = v5.xyz * r1.yyy + float3(0,-0.300000012,0);
  r1.y = dot(r19.xyz, r19.xyz);
  r1.y = rsqrt(r1.y);
  r19.xyz = r19.xyz * r1.yyy;
  r1.y = saturate(dot(-r19.xyz, r3.xyz));
  r19.x = log2(r3.w);
  r19.y = log2(r1.y);
  ...
  r1.xyw = cb9[14].yyy * r18.xyz;
  r0.xyz = r1.xyw * r16.xyz + r0.xyz;
  r1.xyw = cb9[14].zzz * r18.xyz;
  r0.xyz = r1.xyw * r17.xyz + r0.xyz;
  r0.xyz = cb9[14].www * r14.xyz + r0.xyz;
  r1.xyw = cb9[15].xxx * r22.xyz;
  r0.xyz = r1.xyw * r19.xyz + r0.xyz;
  r1.xyw = cb9[15].yyy * r22.xyz;
  r1.xyw = r1.xyw * r20.xyz;
  r0.xyz = r1.xyw * r6.zzz + r0.xyz;
  r1.xyw = cb9[15].zzz * r15.xyz;
  r0.xyz = r1.xyw * r6.zzz + r0.xyz;
  r0.xyz = r21.yyy ? r0.xyz : r10.xyz;
  r1.xyw = r21.yyy ? float3(0,0,0) : r12.xyz;
  r0.xyz = r1.xyw + r0.xyz;
  r0.w = v4.w * r0.w;
  r1.xyz = r9.xyz * r1.zzz;
