  ...
  out float4 o0 : SV_Target0)
{
  ...
  r3.xy = t7.Sample(s7_s, v1.zw).xy;
  r3.zw = -r2.xy * r2.xy + float2(1,1);
  r3.zw = -r3.zw * v3.ww + float2(1,1);
  r1.xy = r3.zw * r1.xy;
  ...
  r11.xyzw = t14.Sample(s14_s, r3.zw).xyzw;
  ...
  r3.yz = r8.xy * cb1[9].xz + cb1[9].yw;
  r3.yz = r6.xx ? r3.yz : r7.xy;
  r3.y = r3.y * r3.z;
  r7.xyw = r3.yyy * r9.xyz + cb3[5].xyz;
  ...
  r15.xyz = r11.xyz * r3.zzz + v6.xyz;
  r16.xyz = r11.www * r3.zzz + v7.xyz;
  ...
  r11.xyz = r11.xyz * r3.zzz + r13.xyz;
  r3.yzw = r11.www * r3.zzz + r22.xyz;
  r11.xyz = r6.www ? r11.xyz : r13.xyz;
  r3.yzw = r6.www ? r3.yzw : r22.xyz;
  r13.xyzw = int4(128,0x8000,16,4) & asint(cb13[0].xxxx);
  r3.yzw = r13.xxx ? float3(0,0,0) : r3.yzw;
  ...
  r1.yzw = r13.yyy ? float3(0,0,0) : r3.yzw;
  r0.xyz = r1.yzw + r0.xyz;
  r1.x = v4.w * r1.x;
  r1.yzw = r10.xyz * r3.xxx;
