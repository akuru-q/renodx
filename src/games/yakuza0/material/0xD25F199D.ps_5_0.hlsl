  ...
  out float4 o0 : SV_Target0)
{
  ...
  r4.xyz = t2.Sample(s2_s, v1.xy).xyz;
  ...
  r1.yzw = r1.www * v4.xyz + r2.xyz;
  r2.x = dot(r1.yzw, r1.yzw);
  r2.x = rsqrt(r2.x);
  r2.yzw = r2.xxx * r1.yzw;
  r3.x = dot(v5.xyz, v5.xyz);
  r3.x = rsqrt(r3.x);
  r4.xyz = v5.xyz * r3.xxx;
  r3.y = saturate(dot(r2.yzw, -cb3[6].xyz));
  ...
  r3.w = r3.w * cb1[10].x + cb1[10].y;
  r3.w = r3.z * r3.w;
  r8.xyz = -cb3[5].xyz + float3(1,1,1);
  r9.xyz = r3.www * r8.xyz + cb3[5].xyz;
  ...
  r12.xyz = r10.xyz * r5.yyy + v6.xyz;
  r13.xyz = r10.www * r5.yyy + v7.xyz;
  r12.xyz = r6.www ? v6.xyz : r12.xyz;
  r13.xyz = r6.www ? v7.xyz : r13.xyz;
  r3.z = saturate(dot(r2.yzw, -cb3[7].xyz));
  r14.xyz = cb3[0].xyz * r3.yyy;
  r15.xyz = cb3[1].xyz * r3.zzz;
  ...
  r17.xyz = v5.xyz * r3.xxx + cb3[6].xyz;
  r3.y = dot(r17.xyz, r17.xyz);
  r3.y = rsqrt(r3.y);
  r17.xyz = r17.xyz * r3.yyy;
  r3.y = saturate(dot(-r17.xyz, r2.yzw));
  r17.xyz = v5.xyz * r3.xxx + float3(0,-0.300000012,0);
  ...
  r17.x = log2(r3.y);
  r17.y = log2(r3.x);
  r3.xy = cb7[10].ww * r17.xy;
  r3.xy = exp2(r3.xy);
  r3.w = cb3[11].x + cb3[11].x;
  r17.xyz = cb3[0].xyz * r3.xxx;
  r18.xyz = cb3[1].xyz * r3.yyy;
  r18.xyz = r18.xyz * r3.www;
  r3.xzw = r18.xyz * r3.zzz;
  r3.xzw = r17.xyz * r5.xzw + r3.xzw;
  r19.xyz = cb6[1].xyz * cb7[10].xyz;
  r3.xzw = r19.xyz * r3.xzw;
  r20.xyz = r13.xyz * r3.yyy;
  r20.xyz = r20.xyz * r8.xyz;
  r3.xzw = r3.xzw * r7.xyw + r20.xyz;
  r10.xyz = r10.xyz * r5.yyy + r9.xyz;
  r20.xyz = r10.www * r5.yyy + r3.xzw;
  r9.xyz = r6.www ? r10.xyz : r9.xyz;
  r3.xzw = r6.www ? r20.xyz : r3.xzw;
  r10.xyzw = int4(128,0x8000,16,4) & asint(cb13[0].xxxx);
  r3.xzw = r10.xxx ? float3(0,0,0) : r3.xzw;
  r6.yzw = r9.xyz * r0.xyz;
  r3.xzw = r3.xzw * r1.xxx;
  ...
  r1.xyz = r10.yyy ? float3(0,0,0) : r3.xzw;
