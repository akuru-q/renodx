  ...
  out float4 o0 : SV_Target0)
{
  ...
  r3.xyz = t7.Sample(s7_s, v1.xy).xyz;
  r1.z = v3.w * r2.w;
  r1.y = r1.y + -r1.x;
  r1.x = r1.z * r1.y + r1.x;
  r2.xyz = r2.xyz * r2.xyz + -r0.xyz;
  r0.xyz = r1.zzz * r2.xyz + r0.xyz;
  r1.yzw = r3.xyz * r3.xyz + -r0.xyz;
  r0.xyz = v2.www * r1.yzw + r0.xyz;
  r1.x = v2.w * -r1.x + r1.x;
  ...
  r11.xyz = r8.xyz * r4.yyy + v6.xyz;
  r12.xyz = r8.www * r4.yyy + v7.xyz;
  ...
  r18.xyz = v4.xyz * r1.yyy + float3(1,1,1);
