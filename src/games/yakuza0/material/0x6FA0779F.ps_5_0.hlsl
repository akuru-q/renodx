  ...
  out float4 o0 : SV_Target0)
{
  ...
  r4.xyz = r1.yzw * r4.xyz + float3(0.00400000019,0.00400000019,0.00400000019);
  ...
  r3.xyz = r2.www ? r1.yzw : r0.xyz;
  r0.x = r0.w * r1.x + -cb7[8].x;
  r0.x = cmp(r0.x < 0);
  if (r0.x != 0) discard;
  r0.xyzw = cb1[3].xyzw * r3.xyzw;
  o0.xyzw = r2.zzzz ? r3.xyzw : r0.xyzw;
  return;
}