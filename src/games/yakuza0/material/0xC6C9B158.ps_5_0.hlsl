  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.zw = cb7[5].xy * v0.zw;
  r4.xyz = t4.Sample(s4_s, r1.zw).xyz;
  r1.zw = t7.Sample(s7_s, v1.xy).xy;
  r3.xyz = -r3.xyz * r3.xyz + float3(1,1,1);
  r3.xyz = -r3.xyz * v3.www + float3(1,1,1);
  ...
  r13.xyz = r11.xyz * r6.yyy + v6.xyz;
  r14.xyz = r11.www * r6.yyy + v7.xyz;
  r13.xyz = r7.www ? v6.xyz : r13.xyz;
  r14.xyz = r7.www ? v7.xyz : r14.xyz;
  r1.w = saturate(dot(r4.xyz, -cb3[7].xyz));
  r15.xyz = cb3[0].xyz * r2.www;
  r16.xyz = cb3[1].xyz * r1.www;
  ...
  r3.xyzw = r3.yxyz * r1.xxxx + float4(0.100000001,1,1,1);
  r1.xyw = saturate(float3(0.5,0.5,0.5) * r3.yzw);
  r1.xyw = cb9[11].yyy * r1.xyw;
  r1.xyw = cb9[11].xxx * r0.xyz + r1.xyw;
  r2.xyz = cb9[11].zzz * r2.xyz;
  r1.xyw = r2.xyz * r21.xyz + r1.xyw;
  r2.x = cb9[11].w * cb7[10].w;
  r1.xyw = r2.xxx * float3(0.00999999978,0.00999999978,0.00999999978) + r1.xyw;
  r1.xyw = cb9[12].xxx * r6.xzw + r1.xyw;
  r1.xyw = cb9[12].yyy * r8.xyw + r1.xyw;
  r1.xyw = cb9[12].zzz * r9.xyz + r1.xyw;
  r1.xyw = cb9[12].www + r1.xyw;
  r1.xyw = cb9[13].xxx * r17.xyz + r1.xyw;
  r1.xyw = cb9[13].yyy * r21.xyz + r1.xyw;
  r2.x = dot(-r5.xyz, r4.xyz);
  r2.x = 1 + -r2.x;
  r2.y = r2.x * r2.x;
  r2.y = r2.y * r2.y;
  r2.y = r2.y * r2.x;
  r2.y = r2.y * 0.972222209 + 0.027777778;
  r1.xyw = cb9[13].zzz * r2.yyy + r1.xyw;
  r1.xyw = cb9[13].www * cb1[13].xyz + r1.xyw;
  r1.xyw = cb9[14].xxx * r12.xyz + r1.xyw;
  r2.yzw = cb9[14].yyy * r17.xyz;
  r1.xyw = r2.yzw * r15.xyz + r1.xyw;
  r2.yzw = cb9[14].zzz * r17.xyz;
  r1.xyw = r2.yzw * r16.xyz + r1.xyw;
  r1.xyw = cb9[14].www * r13.xyz + r1.xyw;
  r2.yzw = cb9[15].xxx * r21.xyz;
  r1.xyw = r2.yzw * r18.xyz + r1.xyw;
  r2.yzw = cb9[15].yyy * r21.xyz;
  r2.yzw = r2.yzw * r19.xyz;
  r1.xyw = r2.yzw * r7.zzz + r1.xyw;
  r2.yzw = cb9[15].zzz * r14.xyz;
  r1.xyw = r2.yzw * r7.zzz + r1.xyw;
  r1.xyw = r20.yyy ? r1.xyw : r10.xyz;
  r2.yzw = r20.yyy ? float3(0,0,0) : r11.xyz;
  r1.xyw = r2.yzw + r1.xyw;
  r3.x = saturate(r3.x);
  r2.y = dot(-r5.xyz, v4.xyz);
