  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.y = rsqrt(r1.y);
  r16.xyz = r16.xyz * r1.yyy;
  r1.y = saturate(dot(-r16.xyz, r2.xyz));
  ...
  r16.x = log2(r1.y);
  r16.y = log2(r1.w);
  r1.yw = cb7[10].ww * r16.xy;
  r1.yw = exp2(r1.yw);
  r2.w = cb3[11].x + cb3[11].x;
  r16.xyz = cb3[0].xyz * r1.yyy;
  r17.xyz = cb3[1].xyz * r1.www;
  r17.xyz = r17.xyz * r2.www;
  r18.xyz = r17.xyz * r1.xxx;
  ...
  r1.xyz = v3.xyz * r1.zzz + float3(1,1,1);
