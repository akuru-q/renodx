  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xyz = -r1.xyz * v2.www + float3(1,1,1);
  ...
  r7.xyz = r5.xyw * cb1[11].xxx + cb1[11].yyy;
  r3.y = cb1[11].z + cb1[11].w;
  r7.xyz = r7.xyz * r3.yyy;
  r7.xyz = r4.xxx ? r7.xyz : r5.xyw;
  r7.xyz = r7.xyz * r5.zzz;
  r9.xyz = cb6[1].www * cb7[11].xyz;
  r10.xyz = r9.xyz * r0.xyz;
  r11.xyz = r8.xyz * r3.zzz + v5.xyz;
  r12.xyz = r8.www * r3.zzz + v6.xyz;
  r11.xyz = r4.www ? v5.xyz : r11.xyz;
  r12.xyz = r4.www ? v6.xyz : r12.xyz;
  r3.y = saturate(dot(r1.yzw, -cb3[7].xyz));
  r13.xyz = cb3[0].xyz * r3.xxx;
  r14.xyz = cb3[1].xyz * r3.yyy;
  r15.xyz = cb6[0].xyz * cb7[9].xyz;
  r16.xyz = r14.xyz * r3.zzz;
  r16.xyz = r13.xyz * r5.xyw + r16.xyz;
  r16.xyz = r15.xyz * r16.xyz + cb1[13].xyz;
  r9.xyz = r9.xyz * r0.xyz + r16.xyz;
  r16.xyz = r11.xyz * r7.xyz;
  r9.xyz = r9.xyz * r6.xyz + r16.xyz;
  r16.xyz = v4.xyz * r2.xxx + cb3[6].xyz;
  r3.x = dot(r16.xyz, r16.xyz);
  r3.x = rsqrt(r3.x);
  r16.xyz = r16.xyz * r3.xxx;
  r3.x = saturate(dot(-r16.xyz, r1.yzw));
  r16.xyz = v4.xyz * r2.xxx + float3(0,-0.300000012,0);
  r2.x = dot(r16.xyz, r16.xyz);
  r2.x = rsqrt(r2.x);
  r16.xyz = r16.xyz * r2.xxx;
  r2.x = saturate(dot(-r16.xyz, r1.yzw));
  r16.x = log2(r3.x);
  r16.y = log2(r2.x);
  r3.xw = cb7[10].ww * r16.xy;
  r3.xw = exp2(r3.xw);
  r2.x = cb3[11].x + cb3[11].x;
  r16.xyz = cb3[0].xyz * r3.xxx;
  r17.xyz = cb3[1].xyz * r3.www;
  r17.xyz = r17.xyz * r2.xxx;
  r18.xyz = r17.xyz * r3.yyy;
  r18.xyz = r16.xyz * r5.xyw + r18.xyz;
  r19.xyz = cb6[1].xyz * cb7[10].xyz;
  r18.xyz = r19.xyz * r18.xyz;
  r20.xyz = r12.xyz * r3.www;
  r20.xyz = r20.xyz * r7.xyz;
  r18.xyz = r18.xyz * r6.xyz + r20.xyz;
  r8.xyz = r8.xyz * r3.zzz + r9.xyz;
  r3.xyz = r8.www * r3.zzz + r18.xyz;
  r8.xyz = r4.www ? r8.xyz : r9.xyz;
  r3.xyz = r4.www ? r3.xyz : r18.xyz;
  r9.xyzw = int4(128,0x8000,16,4) & asint(cb13[0].xxxx);
  r3.xyz = r9.xxx ? float3(0,0,0) : r3.xyz;
  r4.yzw = r8.xyz * r0.xyz;
  ...
  r0.xyz = r1.xyz * r3.www + r0.xyz;
  r0.xyz = r9.yyy ? r0.xyz : r4.yzw;
  r1.xyz = r9.yyy ? float3(0,0,0) : r3.xyz;
  r0.xyz = r1.xyz + r0.xyz;
