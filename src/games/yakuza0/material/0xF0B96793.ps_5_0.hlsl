  ...
  out float4 o0 : SV_Target0)
{
  ...
  r13.xyzw = t14.Sample(s14_s, r7.xy).xyzw;
  r14.xyzw = float4(4,4,4,4) * r13.xyzw;
  r15.xyzw = r13.xyzw + r13.xyzw;
  r13.xyzw = r13.xyzw / cb1[0].zzzz;
  r13.xyzw = r8.wwww ? r15.xyzw : r13.xyzw;
  r13.xyzw = r8.zzzz ? r14.xyzw : r13.xyzw;
  r8.yzw = r13.xyz + r12.xyz;
  r11.xyz = r13.www + r11.xyz;
  r4.w = 1;
  ...
  r12.xyz = max(float3(0.0625,0.0625,0.0625), r12.xyz);
  r0.y = r4.y * 0.5 + 0.5;
  r13.xyz = -cb3[10].xyz + cb3[4].xyz;
  r13.xyz = r0.yyy * r13.xyz + cb3[10].xyz;
  r12.xyz = cb2[79].xxx * r12.xyz + r13.xyz;
  r13.xyz = cb3[0].xyz * r6.zzz;
  r6.xyw = cb3[1].xyz * r6.www;
  r14.xyz = r13.xyz * r2.www + r6.xyw;
  r14.xyz = r14.xyz + r12.xyz;
  r14.xyz = r14.xyz + r8.yzw;
  r15.xyzw = int4(64,0x8000,16,4) & asint(cb13[0].xxxx);
  r16.xyz = r14.xyz * r0.xxx;
  r0.y = r6.z * r2.w;
  r0.w = 1 + -r0.x;
  r0.y = r0.y * r0.w + r0.x;
  r14.xyz = r14.xyz * r0.yyy;
  r14.xyz = r15.xxx ? r14.xyz : r16.xyz;
  r10.xyz = r9.xyz * r10.xyz + r11.xyz;
  ...
  r2.w = cb9[12].y * r7.w;
  r0.yzw = cb9[12].xxx * r7.zzz + r0.yzw;
  r0.xyz = r2.www * r0.xxx + r0.yzw;
