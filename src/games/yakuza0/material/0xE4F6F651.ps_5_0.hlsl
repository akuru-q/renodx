  ...
  out float4 o0 : SV_Target0)
{
  ...
  r3.xy = t6.Sample(s6_s, v2.zw).xy;
  r3.xy = float2(-0.5,-0.5) + r3.xy;
  r3.xy = r0.yy * r3.xy + float2(0.5,0.5);
  r3.zw = cmp(r0.zw < float2(0.5,0.5));
  r4.xy = r3.xy * r0.zw;
  r4.xy = r4.xy + r4.xy;
  ...
  r0.zw = r3.zw ? r4.xy : r0.zw;
  r3.xyz = t4.Sample(s4_s, v2.zw).xyz;
  r3.xyz = float3(1,1,1) + -r3.xyz;
  r3.xyz = -r3.xyz * r0.yyy + float3(1,1,1);
  ...
  r11.xyzw = t14.Sample(s14_s, r0.yz).xyzw;
  ...
  r11.xyz = cb9[11].zzz * r2.xyz;
  r3.xyz = r11.xyz * r8.xyz + r3.xyz;
  r3.xyz = cb9[11].www * r5.xxx + r3.xyz;
  r3.xyz = cb9[12].xxx * r2.www + r3.xyz;
  r3.xyz = cb9[12].yyy * r0.xxx + r3.xyz;
  r11.xyz = cb6[0].xyz * cb7[9].xyz;
  r3.xyz = cb9[13].xxx * r11.xyz + r3.xyz;
  r3.xyz = cb9[13].yyy * r8.xyz + r3.xyz;
  r0.x = r5.w * r5.w;
  r0.x = r0.x * r0.x;
  r0.x = r0.x * r5.w;
