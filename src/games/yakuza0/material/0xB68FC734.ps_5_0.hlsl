  ...
  out float4 o0 : SV_Target0)
{
  ...
  r5.w = -1 + r5.w;
  r6.w = cmp(r5.w < 0);
  r10.xy = r6.ww ? float2(1,30) : 0;
  r11.xyzw = cb2[1].xyzw * r10.xxxx;
  r11.xyzw = cb2[0].xyzw * r6.xxxx + r11.xyzw;
  r5.w = r10.y + r5.w;
  r5.w = -1 + r5.w;
  r6.x = cmp(r5.w < 0);
  r6.xw = r6.xx ? float2(1,30) : 0;
  r10.xyzw = cb2[2].xyzw * r6.xxxx + r11.xyzw;
  r5.w = r6.w + r5.w;
  r5.w = -1 + r5.w;
  r6.x = cmp(r5.w < 0);
  r6.xw = r6.xx ? float2(1,30) : 0;
  ...
  if (r5.w != 0) {
    ...
    r6.w = -r6.x + r5.w;
    r9.w = 6 * r6.w;
    r11.xy = r9.ww * r10.yz + r6.xx;
    r12.xyzw = cmp(r10.yyyz < float4(0.166666672,0.5,0.666666687,0.166666672));
    r11.zw = float2(0.666666687,0.666666687) + -r10.yz;
    r11.zw = r11.zw * r6.ww;
    r11.zw = r11.zw * float2(6,6) + r6.xx;
    r10.y = r12.z ? r11.z : r6.x;
    r10.y = r12.y ? r5.w : r10.y;
    r1.x = r12.x ? r11.x : r10.y;
    r10.x = frac(r10.x);
    r9.w = r9.w * r10.x + r6.x;
    r12.xyz = cmp(r10.xxx < float3(0.166666672,0.5,0.666666687));
    r10.x = 0.666666687 + -r10.x;
    r6.w = r10.x * r6.w;
    r6.w = r6.w * 6 + r6.x;
    r6.w = r12.z ? r6.w : r6.x;
    r6.w = r12.y ? r5.w : r6.w;
    r1.y = r12.x ? r9.w : r6.w;
    r10.xy = cmp(r10.zz < float2(0.5,0.666666687));
    r6.x = r10.y ? r11.w : r6.x;
    r5.w = r10.x ? r5.w : r6.x;
    r1.z = r12.w ? r11.y : r5.w;
  }
  ...
  r12.xyzw = r8.wwww ? r14.xyzw : r12.xyzw;
  r12.xyzw = r8.zzzz ? r13.xyzw : r12.xyzw;
  r8.yzw = r12.xyz + r11.xyz;
  ...
  r0.z = cb9[12].y * r7.w;
  r2.xyz = cb9[12].xxx * r7.zzz + r2.xyz;
