  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xy = int2(8,4) & asint(cb13[0].xx);
  if (r1.x != 0) {
    r1.zw = cb12[29].zw * v3.xy;
    r1.zw = t13.Sample(s13_s, r1.zw).xy;
  } else {
    r1.zw = float2(1,1);
  }
  r2.xy = r1.zw * cb1[9].xz + cb1[9].yw;
  r1.zw = r1.xx ? r2.xy : r1.zw;
  r1.z = r1.z * r1.w;
  r2.xyz = -cb3[5].xyz + float3(1,1,1);
  r2.xyz = r1.zzz * r2.xyz + cb3[5].xyz;
