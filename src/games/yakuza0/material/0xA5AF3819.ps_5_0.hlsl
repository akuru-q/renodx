  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.xy = cb7[4].zw * v0.zw;
  r2.xy = t5.Sample(s5_s, r2.xy).xy;
  r3.xyzw = t1.Sample(s1_s, v1.xy).xyzw;
  r2.zw = cb7[5].zw * v1.xy;
  r2.zw = t6.Sample(s6_s, r2.zw).xy;
  ...
  r6.xyw = v2.xyz * r3.xyz;
  r6.xyz = r6.xyw * r6.zzz;
  r8.xyz = r2.xyz * r3.xyz;
  r9.xyz = r2.xyz * cb1[11].xxx + cb1[11].yyy;
  ...
  r9.xyz = v6.xyz * r3.xyz;
  r9.xyz = r9.xyz * r4.xxx;
  r8.xyz = r8.xyz * r6.xyz + r9.xyz;
  r9.xyz = v5.xyz * r1.www + cb3[6].xyz;
  r1.w = dot(r9.xyz, r9.xyz);
  r1.w = rsqrt(r1.w);
  r9.xyz = r9.xyz * r1.www;
  r1.w = saturate(dot(-r9.xyz, r1.xyz));
  r1.x = saturate(dot(-r4.yzw, r1.xyz));
  r9.x = log2(r1.w);
  r9.y = log2(r1.x);
  r1.xy = cb7[10].ww * r9.xy;
  r1.xy = exp2(r1.xy);
  r1.xzw = cb3[0].xyz * r1.xxx;
  r4.yzw = cb3[1].xyz * r1.yyy;
  r4.yzw = r4.yzw * r3.www;
  r1.xzw = r1.xzw * r2.xyz + r4.yzw;
  r2.xyz = cb6[1].xyz * cb7[10].xyz;
