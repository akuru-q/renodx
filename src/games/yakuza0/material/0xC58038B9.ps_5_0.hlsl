  ...
  out float4 o0 : SV_Target0)
{
  ...
  r3.w = r4.x * r4.y;
  r6.xyw = r3.www * r7.xyz + cb3[5].xyz;
  ...
  r10.xyz = r10.xyz * cb9[1].zzz + cb9[1].www;
  ...
  r17.xyz = v4.xyz * r1.www + cb3[6].xyz;
  r4.x = dot(r17.xyz, r17.xyz);
  r4.x = rsqrt(r4.x);
  r17.xyz = r17.xyz * r4.xxx;
  r4.x = saturate(dot(-r17.xyz, r2.xyz));
  r17.xyz = v4.xyz * r1.www + float3(0,-0.300000012,0);
  r1.w = dot(r17.xyz, r17.xyz);
  r1.w = rsqrt(r1.w);
  r17.xyz = r17.xyz * r1.www;
  r1.w = saturate(dot(-r17.xyz, r2.xyz));
  r17.x = log2(r4.x);
  r17.y = log2(r1.w);
  ...
  r21.xyz = v3.xyz * r1.zzz + float3(1,1,1);
  ...
  r1.yzw = cb9[14].yyy * r16.xyz;
  r0.xyz = r1.yzw * r14.xyz + r0.xyz;
  r1.yzw = cb9[14].zzz * r16.xyz;
  r0.xyz = r1.yzw * r15.xyz + r0.xyz;
  r0.xyz = cb9[14].www * r12.xyz + r0.xyz;
  r1.yzw = cb9[15].xxx * r20.xyz;
  r0.xyz = r1.yzw * r17.xyz + r0.xyz;
  r1.yzw = cb9[15].yyy * r20.xyz;
  r1.yzw = r1.yzw * r18.xyz;
  r0.xyz = r1.yzw * r5.zzz + r0.xyz;
  r1.yzw = cb9[15].zzz * r13.xyz;
  r0.xyz = r1.yzw * r5.zzz + r0.xyz;
  r0.xyz = r19.yyy ? r0.xyz : r8.xyz;
  r1.yzw = r19.yyy ? float3(0,0,0) : r10.xyz;
