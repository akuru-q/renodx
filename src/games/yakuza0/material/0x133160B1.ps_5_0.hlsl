...
// ---- Created with 3Dmigoto v1.3.16 on Fri Oct 10 17:02:03 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.w = -0.5 + w2.x;
  r3.x = cmp(r2.w < 0);
  r3.xy = r3.xx ? float2(1,30) : 0;
  r2.w = r3.y + r2.w;
  r2.w = -1 + r2.w;
  r3.y = cmp(r2.w < 0);
  r9.xy = r3.yy ? float2(1,30) : 0;
  r10.xyzw = cb2[1].xyzw * r9.xxxx;
  r10.xyzw = cb2[0].xyzw * r3.xxxx + r10.xyzw;
  r2.w = r9.y + r2.w;
  r2.w = -1 + r2.w;
  r3.x = cmp(r2.w < 0);
  r3.xy = r3.xx ? float2(1,30) : 0;
  r9.xyzw = cb2[2].xyzw * r3.xxxx + r10.xyzw;
  r2.w = r3.y + r2.w;
  r2.w = -1 + r2.w;
  r3.x = cmp(r2.w < 0);
  r3.xy = r3.xx ? float2(1,30) : 0;
  r9.xyzw = cb2[3].xyzw * r3.xxxx + r9.xyzw;
  r2.w = r3.y + r2.w;
  r2.w = -1 + r2.w;
  r3.x = cmp(r2.w < 0);
  r3.xy = r3.xx ? float2(1,30) : 0;
  r9.xyzw = cb2[4].xyzw * r3.xxxx + r9.xyzw;
  r2.w = r3.y + r2.w;
  r2.w = -1 + r2.w;
  r3.x = cmp(r2.w < 0);
  r3.xy = r3.xx ? float2(1,30) : 0;
  r9.xyzw = cb2[5].xyzw * r3.xxxx + r9.xyzw;
  r2.w = r3.y + r2.w;
  r2.w = -1 + r2.w;
  r3.x = cmp(r2.w < 0);
  r3.xy = r3.xx ? float2(1,30) : 0;
  r9.xyzw = cb2[6].xyzw * r3.xxxx + r9.xyzw;
  r2.w = r3.y + r2.w;
  r2.w = -1 + r2.w;
  r3.x = cmp(r2.w < 0);
  r3.xy = r3.xx ? float2(1,30) : 0;
  r9.xyzw = cb2[7].xyzw * r3.xxxx + r9.xyzw;
  r2.w = r3.y + r2.w;
  r2.w = -1 + r2.w;
  r3.x = cmp(r2.w < 0);
  r3.xy = r3.xx ? float2(1,30) : 0;
  r9.xyzw = cb2[8].xyzw * r3.xxxx + r9.xyzw;
  r2.w = r3.y + r2.w;
  r2.w = -1 + r2.w;
  r2.w = cmp(r2.w < 0);
  r2.w = r2.w ? 1.000000 : 0;
  r9.xyzw = cb2[9].xyzw * r2.wwww + r9.xyzw;
  r2.w = max(r5.x, r5.y);
  r2.w = max(r2.w, r5.z);
  r3.x = min(r5.x, r5.y);
  r3.x = min(r3.x, r5.z);
  ...
  if (r2.w != 0) {
    ...
    r3.y = -r3.x + r2.w;
    r4.w = 6 * r3.y;
    r10.xy = r4.ww * r9.yz + r3.xx;
    r11.xyzw = cmp(r9.yyyz < float4(0.166666672,0.5,0.666666687,0.166666672));
    r10.zw = float2(0.666666687,0.666666687) + -r9.yz;
    r10.zw = r10.zw * r3.yy;
    r10.zw = r10.zw * float2(6,6) + r3.xx;
    r5.w = r11.z ? r10.z : r3.x;
    r5.w = r11.y ? r2.w : r5.w;
    r5.x = r11.x ? r10.x : r5.w;
    r5.w = frac(r9.x);
    r4.w = r4.w * r5.w + r3.x;
    r11.xyz = cmp(r5.www < float3(0.166666672,0.5,0.666666687));
    r5.w = 0.666666687 + -r5.w;
    r3.y = r5.w * r3.y;
    r3.y = r3.y * 6 + r3.x;
    r3.y = r11.z ? r3.y : r3.x;
    r3.y = r11.y ? r2.w : r3.y;
    r5.y = r11.x ? r4.w : r3.y;
    r9.xy = cmp(r9.zz < float2(0.5,0.666666687));
    r3.x = r9.y ? r10.w : r3.x;
    r2.w = r9.x ? r2.w : r3.x;
    r5.z = r11.w ? r10.y : r2.w;
  }
