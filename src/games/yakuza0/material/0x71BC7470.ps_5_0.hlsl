  ...
  out float4 o0 : SV_Target0)
{
  ...
  r4.yzw = cb7[6].xxx * v8.xyz;
  r6.xyzw = t12.Sample(s12_s, r4.yzw).xyzw;
  r6.xyzw = r6.xyzw * float4(2,2,2,2) + float4(-1,-1,-1,-1);
  r4.yzw = r6.xyz + -r6.www;
  r2.xyz = r4.yzw * cb7[6].yyy + r2.yzw;
  r2.w = dot(r2.xyz, r2.xyz);
  r2.w = rsqrt(r2.w);
  r2.xyz = r2.xyz * r2.www;
  r2.w = dot(r3.yzw, r2.xyz);
  r2.w = r2.w + r2.w;
  r2.xyz = r2.xyz * -r2.www + r3.yzw;
