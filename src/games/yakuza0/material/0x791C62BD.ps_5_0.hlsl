  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.z = r1.z * cb1[10].x + cb1[10].y;
  r1.z = r1.y * r1.z;
  r7.xyz = -cb3[5].xyz + float3(1,1,1);
  r8.xyz = r1.zzz * r7.xyz + cb3[5].xyz;
  ...
  r1.z = r4.x * r4.y;
  r4.xzw = r1.zzz * r7.xyz + cb3[5].xyz;
  ...
  r1.yzw = v3.xyz * r1.www + float3(1,1,1);
  ...
  r1.xyz = r18.yyy ? float3(0,0,0) : r9.xyz;
