  ...
  out float4 o0 : SV_Target0)
{
  ...
  r7.xyz = v2.xyz * r9.xyz;
  r7.xyz = r7.xyz * r6.zzz;
  r8.xyz = r6.xyw * r9.xyz;
  r11.xyz = r6.xyw * cb1[11].xxx + cb1[11].yyy;
  r9.xyz = r9.xyz * cb1[11].zzz + cb1[11].www;
  r9.xyz = r11.xyz * r9.xyz;
  r8.xyz = r5.xxx ? r9.xyz : r8.xyz;
  r8.xyz = r8.xyz * r1.zzz;
  r8.xyz = r8.xyz * r6.zzz;
  r9.xyz = cb6[1].www * cb7[11].xyz;
  r11.xyz = r9.xyz * r0.xyz;
  r12.xyz = r10.xyz * r4.zzz + v6.xyz;
  r13.xyz = r10.www * r4.zzz + v7.xyz;
  r12.xyz = r5.www ? v6.xyz : r12.xyz;
  r13.xyz = r5.www ? v7.xyz : r13.xyz;
  r1.z = saturate(dot(r2.yzw, -cb3[7].xyz));
  r4.xyw = cb3[0].xyz * r4.xxx;
  r14.xyz = cb3[1].xyz * r1.zzz;
  r15.xyz = cb6[0].xyz * cb7[9].xyz;
  r16.xyz = r14.xyz * r4.zzz;
  r16.xyz = r4.xyw * r6.xyw + r16.xyz;
  r16.xyz = r15.xyz * r16.xyz + cb1[13].xyz;
  r9.xyz = r9.xyz * r0.xyz + r16.xyz;
  r16.xyz = r12.xyz * r8.xyz;
  r9.xyz = r9.xyz * r7.xyz + r16.xyz;
  r16.xyz = v5.xyz * r3.xxx + cb3[6].xyz;
  r1.w = dot(r16.xyz, r16.xyz);
  r1.w = rsqrt(r1.w);
  r16.xyz = r16.xyz * r1.www;
  r1.w = saturate(dot(-r16.xyz, r2.yzw));
  r16.xyz = v5.xyz * r3.xxx + float3(0,-0.300000012,0);
  r3.x = dot(r16.xyz, r16.xyz);
  r3.x = rsqrt(r3.x);
  r16.xyz = r16.xyz * r3.xxx;
  r3.x = saturate(dot(-r16.xyz, r2.yzw));
  r16.x = log2(r1.w);
  r16.y = log2(r3.x);
  r5.yz = cb7[10].ww * r16.xy;
  r5.yz = exp2(r5.yz);
  r1.w = cb3[11].x + cb3[11].x;
  r16.xyz = cb3[0].xyz * r5.yyy;
  r17.xyz = cb3[1].xyz * r5.zzz;
  r17.xyz = r17.xyz * r1.www;
  r18.xyz = r17.xyz * r1.zzz;
  r18.xyz = r16.xyz * r6.xyw + r18.xyz;
  r19.xyz = cb6[1].xyz * cb7[10].xyz;
  r18.xyz = r19.xyz * r18.xyz;
  r20.xyz = r13.xyz * r5.zzz;
  r20.xyz = r20.xyz * r8.xyz;
  r18.xyz = r18.xyz * r7.xyz + r20.xyz;
  r10.xyz = r10.xyz * r4.zzz + r9.xyz;
  r20.xyz = r10.www * r4.zzz + r18.xyz;
  r9.xyz = r5.www ? r10.xyz : r9.xyz;
  r10.xyz = r5.www ? r20.xyz : r18.xyz;
  r18.xyzw = int4(128,0x8000,16,4) & asint(cb13[0].xxxx);
  r10.xyz = r18.xxx ? float3(0,0,0) : r10.xyz;
  r9.xyz = r9.xyz * r0.xyz;
  r10.xyz = r10.xyz * r1.xxx;
  r20.xyz = v4.xyz * r2.xxx + float3(1,1,1);
  r20.xyz = saturate(float3(0.5,0.5,0.5) * r20.xyz);
  r20.xyz = cb9[11].yyy * r20.xyz;
  r0.xyz = cb9[11].xxx * r0.xyz + r20.xyz;
  r1.x = cb9[11].z * r1.x;
  ...
  r1.xzw = cb9[14].yyy * r15.xyz;
  r0.xyz = r1.xzw * r4.xyw + r0.xyz;
  r1.xzw = cb9[14].zzz * r15.xyz;
  r0.xyz = r1.xzw * r14.xyz + r0.xyz;
  r0.xyz = cb9[14].www * r12.xyz + r0.xyz;
  r1.xzw = cb9[15].xxx * r19.xyz;
  r0.xyz = r1.xzw * r16.xyz + r0.xyz;
  r1.xzw = cb9[15].yyy * r19.xyz;
  r1.xzw = r1.xzw * r17.xyz;
  r0.xyz = r1.xzw * r5.zzz + r0.xyz;
  r1.xzw = cb9[15].zzz * r13.xyz;
  r0.xyz = r1.xzw * r5.zzz + r0.xyz;
  r0.xyz = r18.yyy ? r0.xyz : r9.xyz;
  r1.xzw = r18.yyy ? float3(0,0,0) : r10.xyz;
  ...
  r2.xyz = sqrt(r2.xyz);
  r0.xyz = r18.yyy ? r0.xyz : r2.xyz;
  r0.xyz = r18.zzz ? r3.xyz : r0.xyz;
  r2.xyz = v3.xyz + r0.xyz;
  r0.w = saturate(v3.x);
  r3.xyz = cb1[1].xyz + -r0.xyz;
  r0.xyz = r0.www * r3.xyz + r0.xyz;
  r1.xyz = r18.www ? r2.xyz : r0.xyz;
