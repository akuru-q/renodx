  ...
  out float4 o0 : SV_Target0)
{
  ...
  r3.z = saturate(dot(r4.xyz, -cb3[6].xyz));
  ...
  r3.x = saturate(dot(r4.xyz, -cb3[7].xyz));
  r15.xyz = cb3[0].xyz * r3.zzz;
  r16.xyz = cb3[1].xyz * r3.xxx;
  ...
  r3.y = dot(r18.xyz, r18.xyz);
  r3.y = rsqrt(r3.y);
  r18.xyz = r18.xyz * r3.yyy;
  r3.y = saturate(dot(-r18.xyz, r4.xyz));
  ...
  r18.x = log2(r3.y);
  r18.y = log2(r2.w);
  r3.yz = cb7[10].ww * r18.xy;
  r3.yz = exp2(r3.yz);
  r2.w = cb3[11].x + cb3[11].x;
  r18.xyz = cb3[0].xyz * r3.yyy;
  r19.xyz = cb3[1].xyz * r3.zzz;
  r19.xyz = r19.xyz * r2.www;
  r20.xyz = r19.xyz * r3.xxx;
