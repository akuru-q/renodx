  ...
  out float4 o0 : SV_Target0)
{
  ...
  r14.xyz = r10.xyz * r5.yyy + v6.xyz;
  r15.xyz = r10.www * r5.yyy + v7.xyz;
  r14.xyz = r6.www ? v6.xyz : r14.xyz;
  r15.xyz = r6.www ? v7.xyz : r15.xyz;
  r3.y = saturate(dot(r2.yzw, -cb3[7].xyz));
  r4.w = saturate(r3.w);
  ...
  r19.xyz = v5.xyz * r3.zzz + cb3[6].xyz;
  r4.w = dot(r19.xyz, r19.xyz);
  r4.w = rsqrt(r4.w);
  r19.xyz = r19.xyz * r4.www;
  r4.w = saturate(dot(-r19.xyz, r2.yzw));
  r19.xyz = v5.xyz * r3.zzz + float3(0,-0.300000012,0);
  r3.z = dot(r19.xyz, r19.xyz);
  r3.z = rsqrt(r3.z);
  r19.xyz = r19.xyz * r3.zzz;
  r3.z = saturate(dot(-r19.xyz, r2.yzw));
  r19.x = log2(r4.w);
  r19.y = log2(r3.z);
  r6.yz = cb7[10].ww * r19.xy;
  r6.yz = exp2(r6.yz);
  r3.z = cb3[11].x + cb3[11].x;
  r19.xyz = cb3[0].xyz * r6.yyy;
  r20.xyz = cb3[1].xyz * r6.zzz;
  r20.xyz = r20.xyz * r3.zzz;
  ...
  r23.xyz = v4.xyz * r2.xxx + float3(1,1,1);
  r23.xyz = saturate(float3(0.5,0.5,0.5) * r23.xyz);
  r23.xyz = cb9[11].yyy * r23.xyz;
  r0.xyz = cb9[11].xxx * r0.xyz + r23.xyz;
  r23.xyz = cb9[11].zzz * r1.xyz;
  r0.xyz = r23.xyz * r22.xyz + r0.xyz;
  ...
  r6.yzw = r21.yyy ? float3(0,0,0) : r12.xyz;
