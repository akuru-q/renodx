  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.yzw = r1.yzw * cb1[11].zzz + cb1[11].www;
  r1.yzw = r9.xyz * r1.yzw;
  r1.yzw = r5.zzz ? r1.yzw : r8.xyz;
  ...
  r4.x = log2(r2.w);
  r4.y = log2(r3.x);
  r3.xy = cb7[10].ww * r4.xy;
  r3.xy = exp2(r3.xy);
  r3.xzw = cb3[0].xyz * r3.xxx;
  r4.xyz = cb3[1].xyz * r3.yyy;
  r4.xyz = r4.xyz * r4.www;
  r2.xyz = r3.xzw * r2.xyz + r4.xyz;
