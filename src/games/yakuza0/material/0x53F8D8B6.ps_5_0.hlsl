  ...
  out float4 o0 : SV_Target0)
{
  ...
  r5.x = r5.x * r0.z;
  r5.x = exp2(r5.x);
  r5.yzw = cb6[1].xyz * cb7[10].xyz;
  r8.xyz = r5.xxx * r5.yzw;
  r8.xyz = cb3[0].xyz * r8.xyz;
  r2.z = saturate(r2.z);
  r2.z = 1 + -r2.z;
  r2.z = r2.z * r2.z;
  r2.z = r4.w * r2.z;
  r8.xyz = r8.xyz * r0.www + r2.zzz;
  ...
  r11.xyzw = float4(4,4,4,4) * r2.xyzw;
  r12.xyzw = int4(8192,64,0x8000,16) & asint(cb13[0].xxxx);
  r13.xyzw = r2.xyzw + r2.xyzw;
  r2.xyzw = r2.xyzw / cb1[0].zzzz;
  r2.xyzw = r12.xxxx ? r13.xyzw : r2.xyzw;
  r2.xyzw = r7.wwww ? r11.xyzw : r2.xyzw;
  r2.xyz = r10.xyz + r2.xyz;
  r7.xzw = r9.xyz + r2.www;
  r3.w = 1;
  ...
  r3.xyz = cb2[79].xxx * r9.xyz + r3.xyz;
  r9.xyz = cb3[0].xyz * r0.zzz;
  r10.xyz = cb3[1].xyz * r2.www;
  r11.xyz = r9.xyz * r0.www + r10.xyz;
  ...
  r11.xyz = r12.yyy ? r11.xyz : r13.xyz;
  r8.xyz = r8.xyz + r7.xzw;
  r6.xyz = saturate(float3(0.5,0.5,0.5) * r6.yzw);
  r6.xyz = cb9[11].yyy * r6.xyz;
  r6.xyz = cb9[11].xxx * r1.xyz + r6.xyz;
  r0.z = cb9[11].z * r0.x;
  r6.xyz = r0.zzz * r5.yzw + r6.xyz;
  r6.xyz = cb9[11].www * r8.xxx + r6.xyz;
  r0.z = cb9[12].y * r4.z;
  r4.yzw = cb9[12].xxx * r4.yyy + r6.xyz;
  r0.yzw = r0.zzz * r0.yyy + r4.yzw;
  r4.yzw = cb6[0].xyz * cb7[9].xyz;
  r0.yzw = cb9[13].xxx * r4.yzw + r0.yzw;
  r0.yzw = cb9[13].yyy * r5.yzw + r0.yzw;
  r2.w = r4.x * r4.x;
  r2.w = r2.w * r2.w;
  r2.w = r2.w * r4.x;
