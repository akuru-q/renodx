  ...
  out float4 o0 : SV_Target0)
{
  ...
  r5.w = v2.z * r5.w;
  r11.y = r5.w * 0.200000003 + 0.5;
  r5.w = t7.Sample(s7_s, r11.xy).x;
  r8.w = dot(-r8.xyz, r10.xyz);
  r8.w = v2.w * r8.w;
  r11.z = r8.w * 0.200000003 + 0.5;
  r8.w = t7.Sample(s7_s, r11.xz).x;
  r5.w = r8.w * r5.w;
  r9.x = log2(r2.w);
  r9.y = log2(r5.w);
  r9.xy = r9.xy * r0.zz;
  ...
  r12.xyz = r10.xyz * r4.www + r11.xyz;
  ...
  r0.yzw = saturate(r3.xyz * r5.xyz + r0.yzw);
