  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.x = v4.w * r2.x;
  r1.yzw = r10.xyz * r1.zzz;
  r2.x = dot(r5.xyz, r4.xyz);
  r2.x = r2.x + r2.x;
  r3.xyz = r4.xyz * -r2.xxx + r5.xyz;
