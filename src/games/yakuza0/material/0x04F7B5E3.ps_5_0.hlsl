  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.w = min(r7.z, r7.w);
  r9.xy = cb9[6].xy * r0.zz;
  r0.z = saturate(dot(-r5.xyz, r3.xyz));
  r0.z = log2(r0.z);
  r0.z = r9.x * r0.z;
  r0.z = exp2(r0.z);
  r5.xyz = cb6[1].xyz * cb7[10].xyz;
  r9.xzw = cb9[4].www * r5.xyz;
  r9.xzw = r9.xzw * r0.zzz;
  ...
  r6.xyz = saturate(r9.xzw * cb3[0].xyz + r6.xyz);
  ...
  r10.xyz = t14.Sample(s14_s, r7.xy).xyz;
  r11.xyz = float3(4,4,4) * r10.xyz;
  r12.xyz = r10.xyz + r10.xyz;
  r10.xyz = r10.xyz / cb1[0].zzz;
  r10.xyz = r8.www ? r12.xyz : r10.xyz;
  r8.yzw = r8.zzz ? r11.xyz : r10.xyz;
  ...
  r10.xyz = cb3[0].xyz * r0.zzz;
  r11.xyz = cb3[1].xyz * r3.www;
  r12.xyz = r10.xyz * r0.www + r11.xyz;
  ...
  r3.w = 1;
  r0.xyzw = r13.yyyy ? r3.wxyz : r6.wxyz;
