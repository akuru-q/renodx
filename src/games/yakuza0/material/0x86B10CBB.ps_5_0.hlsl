  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.w = rsqrt(r2.w);
  r3.xyz = r2.www * r1.yzw;
  r3.w = dot(v4.xyz, v4.xyz);
  r3.w = rsqrt(r3.w);
  r4.xyz = v4.xyz * r3.www;
  r4.w = saturate(dot(r3.xyz, -cb3[6].xyz));
  ...
  r6.y = saturate(dot(r3.xyz, -cb3[7].xyz));
  r14.xyz = cb3[0].xyz * r4.www;
  r15.xyz = cb3[1].xyz * r6.yyy;
  ...
  r17.xyz = v4.xyz * r3.www + cb3[6].xyz;
  r4.w = dot(r17.xyz, r17.xyz);
  r4.w = rsqrt(r4.w);
  r17.xyz = r17.xyz * r4.www;
  r4.w = saturate(dot(-r17.xyz, r3.xyz));
  r17.xyz = v4.xyz * r3.www + float3(0,-0.300000012,0);
  ...
  r17.x = log2(r4.w);
  r17.y = log2(r3.w);
  r17.xy = cb7[10].ww * r17.xy;
  r17.xy = exp2(r17.xy);
  r3.w = cb3[11].x + cb3[11].x;
  r17.xzw = cb3[0].xyz * r17.xxx;
  r18.xyz = cb3[1].xyz * r17.yyy;
  r18.xyz = r18.xyz * r3.www;
  r19.xyz = r18.xyz * r6.yyy;
  r19.xyz = r17.xzw * r5.xzw + r19.xyz;
  r20.xyz = cb6[1].xyz * cb7[10].xyz;
  r19.xyz = r20.xyz * r19.xyz;
  r21.xyz = r17.yyy * r13.xyz;
  ...
  r1.yzw = r1.yzw * r2.www + float3(1,1,1);
