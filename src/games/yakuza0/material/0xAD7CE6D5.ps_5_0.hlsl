  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xyz = t3.Sample(s3_s, v0.zw).xyz;
  r2.xy = t5.Sample(s5_s, v1.xy).xy;
  ...
  r10.xyz = r2.www * r9.xyz + cb3[5].xyz;
  ...
  r2.w = r6.x * r6.y;
  r8.xyw = r2.www * r9.xyz + cb3[5].xyz;
  ...
  r13.xyz = r13.xyz * cb9[0].xxx + cb9[0].yyy;
  r14.xyz = r13.xyz * r0.xyz;
  r15.xyzw = r11.xyzw * r6.yyyy;
  r15.xyzw = r7.wwww ? float4(0,0,0,0) : r15.xyzw;
  r2.w = saturate(dot(r4.xyz, -cb3[7].xyz));
  r3.w = saturate(r2.y);
  r16.xyz = cb3[0].xyz * r3.www;
  r17.xyz = cb3[1].xyz * r2.www;
  r18.xyz = cb6[0].xyz * cb7[9].xyz;
  r19.xyz = r17.xyz * r6.yyy;
  r19.xyz = r16.xyz * r8.xyw + r19.xyz;
  r19.xyz = r18.xyz * r19.xyz + cb1[13].xyz;
  r13.xyz = r13.xyz * r0.xyz + r19.xyz;
  r19.xyz = r15.xyz * r12.xyz;
  r13.xyz = r13.xyz * r9.xyz + r19.xyz;
  r19.xyz = v5.xyz * r2.xxx + cb3[6].xyz;
  r3.w = dot(r19.xyz, r19.xyz);
  r3.w = rsqrt(r3.w);
  r19.xyz = r19.xyz * r3.www;
  r3.w = saturate(dot(-r19.xyz, r4.xyz));
  r19.xyz = v5.xyz * r2.xxx + float3(0,-0.300000012,0);
  r2.x = dot(r19.xyz, r19.xyz);
  r2.x = rsqrt(r2.x);
  r19.xyz = r19.xyz * r2.xxx;
  r2.x = saturate(dot(-r19.xyz, r4.xyz));
  r19.x = log2(r3.w);
  r19.y = log2(r2.x);
  ...
  r3.xyz = cb9[14].yyy * r18.xyz;
  r0.xyz = r3.xyz * r16.xyz + r0.xyz;
  r3.xyz = cb9[14].zzz * r18.xyz;
  r0.xyz = r3.xyz * r17.xyz + r0.xyz;
  r0.xyz = cb9[14].www * r15.xyz + r0.xyz;
  r3.xyz = cb9[15].xxx * r22.xyz;
  r0.xyz = r3.xyz * r19.xyz + r0.xyz;
  r3.xyz = cb9[15].yyy * r22.xyz;
  r3.xyz = r3.xyz * r20.xyz;
  r0.xyz = r3.xyz * r7.zzz + r0.xyz;
  r1.y = cb9[15].z * r15.w;
  r0.xyz = r1.yyy * r7.zzz + r0.xyz;
  r0.xyz = r21.yyy ? r0.xyz : r11.xyz;
  r3.xyz = r21.yyy ? float3(0,0,0) : r13.xyz;
  r0.xyz = r3.xyz + r0.xyz;
  r1.x = v4.w * r1.x;
  r2.xzw = r10.xyz * r2.zzz;
  r3.x = v5.w;
  r3.y = v6.w;
  r3.z = v7.w;
  r3.xyz = cb7[6].xxx * r3.xyz;
  r3.xyzw = t12.Sample(s12_s, r3.xyz).xyzw;
  r3.xyzw = r3.xyzw * float4(2,2,2,2) + float4(-1,-1,-1,-1);
  r3.xyz = r3.xyz + -r3.www;
  r3.xyz = r3.xyz * cb7[6].yyy + r4.xyz;
  ...
  r3.xyzw = t6.Sample(s6_s, r3.xyz).xyzw;
  r1.y = r6.z * r6.w;
  r1.w = saturate(0.75 + r2.y);
  r1.y = r1.y * r1.w;
  r1.y = max(cb3[11].y, r1.y);
  r1.w = max(0.00392156886, r3.w);
  r1.w = 0.25 / r1.w;
