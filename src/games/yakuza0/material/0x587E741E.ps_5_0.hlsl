...
// ---- Created with 3Dmigoto v1.3.16 on Fri Oct 10 17:02:09 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r9.xyz = float3(4,4,4) * r2.xyw;
  r10.xyzw = int4(8192,64,0x8000,16) & asint(cb13[0].xxxx);
  r11.xyz = r2.xyw + r2.xyw;
  r2.xyw = r2.xyw / cb1[0].zzz;
  r2.xyw = r10.xxx ? r11.xyz : r2.xyw;
  r2.xyw = r7.www ? r9.xyz : r2.xyw;
  r2.xyw = r8.xyz + r2.xyw;
  r3.w = 1;
  ...
  r9.xyz = r7.xzw * r0.www + r8.xyz;
  r9.xyz = r9.xyz + r3.yzw;
  r9.xyz = r9.xyz + r2.xyw;
  r11.xyz = r9.xyz * r0.yyy;
  r0.z = r0.z * r0.w;
  r3.x = 1 + -r0.y;
  r0.z = r0.z * r3.x + r0.y;
  r9.xyz = r9.xyz * r0.zzz;
  r9.xyz = r10.yyy ? r9.xyz : r11.xyz;
  ...
  r1.xyz = sqrt(r1.xyz);
  r0.xyz = r10.zzz ? r0.xyz : r1.xyz;
  r0.xyz = r10.www ? r3.xyz : r0.xyz;
