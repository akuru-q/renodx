...
void main(
  ...
  float4 v1: COLOR1,
  float3 v2: TEXCOORD0,
  float4 w2: TEXCOORD6,  // float w2 : TEXCOORD6,
  float4 v3 : TEXCOORD1,
  float4 v4 : TEXCOORD2,
  float4 v5 : TEXCOORD3,
  float4 v6 : TEXCOORD4,
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r6.xyz = r1.xyz * cb7[5].xyz + -r1.xyz;
  r1.xyz = w2.xww * r6.xyz + r1.xyz;
  ...
  r13.xyzw = int4(8192,64,512,0x8000) & asint(cb13[0].xxxx);
  r15.xyzw = r5.xyzw + r5.xyzw;
  r5.xyzw = r5.xyzw / cb1[0].zzzz;
  r5.xyzw = r13.xxxx ? r15.xyzw : r5.xyzw;
  ...
  r9.xyz = r13.yyy ? r9.xyz : r10.xyz;
  r2.w = saturate(-v2.z + r0.y);
  r3.w = 1 + -r2.w;
  r0.z = r0.z * r3.w + r2.w;
  r10.xyz = r12.xyz * r0.zzz;
  r10.xyz = r13.zzz ? r12.xyz : r10.xyz;
