  ...
  out float4 o0 : SV_Target0)
{
  ...
  r8.x = cb7[10].w * 0.0397435986 + 0.0856831968;
  r5.zw = r8.xx * r5.zw;
  ...
  r5.z = saturate(dot(r2.xyz, -v7.xyz));
  r11.x = v0.w;
  r11.y = v1.w;
  r11.z = v7.w;
  ...
  r1.xyz = cb9[13].xxx * r13.xyz + r1.xyz;
  ...
  r1.xyz = cb9[13].www * r9.xyz + r1.xyz;
  ...
  r1.xyz = r2.xyz * r4.xyz + r1.xyz;
  r1.xyz = saturate(cb9[15].zzz * r6.yzw + r1.xyz);
