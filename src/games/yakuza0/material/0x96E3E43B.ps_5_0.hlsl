  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xyzw = t3.Sample(s3_s, v0.zw).xyzw;
  ...
  r15.xyz = r11.xyz * r6.yyy + v6.xyz;
  r16.xyz = r11.www * r6.yyy + v7.xyz;
  ...
  r2.xyw = r3.xyz * r2.xxx + float3(1,1,1);
  r2.xyw = saturate(float3(0.5,0.5,0.5) * r2.xyw);
  r2.xyw = cb9[11].yyy * r2.xyw;
  r0.xyz = cb9[11].xxx * r0.xyz + r2.xyw;
  r2.xyw = cb9[11].zzz * r1.xyz;
  r0.xyz = r2.xyw * r23.xyz + r0.xyz;
  ...
  r2.xyw = cb9[14].yyy * r19.xyz;
  r0.xyz = r2.xyw * r17.xyz + r0.xyz;
  r2.xyw = cb9[14].zzz * r19.xyz;
  r0.xyz = r2.xyw * r18.xyz + r0.xyz;
  r0.xyz = cb9[14].www * r15.xyz + r0.xyz;
  r2.xyw = cb9[15].xxx * r23.xyz;
  r0.xyz = r2.xyw * r20.xyz + r0.xyz;
  r2.xyw = cb9[15].yyy * r23.xyz;
  r2.xyw = r2.xyw * r21.xyz;
  r0.xyz = r2.xyw * r7.zzz + r0.xyz;
  r2.xyw = cb9[15].zzz * r16.xyz;
  r0.xyz = r2.xyw * r7.zzz + r0.xyz;
  r0.xyz = r22.yyy ? r0.xyz : r11.xyz;
  r2.xyw = r22.yyy ? float3(0,0,0) : r13.xyz;
  r0.xyz = r2.xyw + r0.xyz;
  r1.w = v4.w * r1.w;
  r2.xyz = r10.xyz * r2.zzz;
