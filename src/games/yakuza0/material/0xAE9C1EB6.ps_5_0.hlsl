  ...
  out float4 o0 : SV_Target0)
{
  ...
  r7.xzw = cb9[4].www * r4.yzw;
  r7.xzw = r7.xzw * r4.xxx;
  ...
  r1.yzw = saturate(r7.xzw * cb3[0].xyz + r1.yzw);
  ...
  r12.xyz = cb9[11].zzz * r4.yzw + r12.xyz;
  r12.xyz = cb9[11].www * r11.www + r12.xyz;
  ...
  r5.xyz = cb9[13].yyy * r4.yzw + r5.xyz;
  ...
  r2.xyz = cb9[13].www * r7.xyz + r2.xyz;
  r3.xyz = cb9[14].yyy * r12.xyz;
  r2.xyz = r3.xyz * r8.xyz + r2.xyz;
  r3.xyz = cb9[14].zzz * r12.xyz;
  r2.xyz = r3.xyz * r9.xyz + r2.xyz;
  r2.xyz = cb9[14].www * r6.yzw + r2.xyz;
  r3.xyz = cb9[15].xxx * r4.yzw;
  r2.xyz = r3.xyz * r11.wxy + r2.xyz;
  r3.xyz = cb9[15].yyy * r4.yzw;
  r2.xyz = saturate(r3.xyz * r11.wxy + r2.xyz);
  r0.xyz = r10.xyz * r0.xyz;
  r11.xyz = r0.xyz * r12.xyz + r11.wxy;
  r2.w = 1;
  r2.xyzw = r1.yyyy ? r2.wxyz : r11.wxyz;
