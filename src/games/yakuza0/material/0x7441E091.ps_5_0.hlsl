  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (r0.z != 0) {
    ...
    r8.w = r10.z ? r11.x : r0.w;
    r8.w = r10.y ? r0.z : r8.w;
    r1.x = r10.x ? r9.z : r8.w;
    r8.w = frac(cb2[10].x);
    r5.w = r5.w * r8.w + r0.w;
    r10.xyz = cmp(r8.www < float3(0.166666672,0.5,0.666666687));
    r8.w = 0.666666687 + -r8.w;
    r4.w = r8.w * r4.w;
    r4.w = r4.w * 6 + r0.w;
  ...
  r0.xzw = cb9[12].xxx * r6.zzz + r0.xzw;
  r0.xzw = cb9[12].yyy * r6.www + r0.xzw;
  ...
  r0.xzw = cb9[13].www * r9.xyz + r0.xzw;
  r3.xyz = cb9[14].yyy * r2.xyz;
  r0.xzw = r3.xyz * r10.xyz + r0.xzw;
  r3.xyz = cb9[14].zzz * r2.xyz;
  r0.xzw = r3.xyz * r11.xyz + r0.xzw;
  r0.xzw = cb9[14].www * r7.yzw + r0.xzw;
