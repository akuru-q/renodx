...
// ---- Created with 3Dmigoto v1.3.16 on Sat Oct 11 15:29:08 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.z = cb7[10].w * r0.z;
  r0.z = max(1, r0.z);
  r2.zw = t7.Sample(s7_s, v2.xy).xy;
  r2.zw = float2(-0.5,-0.5) + r2.zw;
  r2.zw = v2.ww * r2.zw + float2(0.5,0.5);
  ...
  r13.xyz = cb9[7].www * float3(0,1,0) + r4.xyz;
  r12.xyz = r12.xyz * cb9[7].zzz + r13.xyz;
  ...
  r8.z = cb9[7].x * r8.z;
  r7.x = r7.x ? r8.z : 0;
  r12.xyz = cb6[1].xyz * cb7[10].xyz;
  r13.xyz = cb3[0].xyz * r5.xxx;
  r14.xyz = cb3[1].xyz * r5.yyy;
  r13.xyz = r13.xyz * r4.www + r14.xyz;
  ...
  if (r7.z != 0) {
    ...
    r14.y = v4.w;
    r14.z = v6.w;
    r15.xyz = r14.xyz * r5.xxx;
    r15.xyz = max(float3(0,0,0), r15.xyz);
    r5.y = saturate(dot(r3.xyz, -v7.xyz));
    r16.x = v0.w;
    r16.y = v1.w;
    r16.z = v7.w;
    r17.xyz = r16.xyz * r5.yyy;
    r17.xyz = max(float3(0,0,0), r17.xyz);
    r15.xyz = r17.xyz + r15.xyz;
    r17.xyz = v3.xyz * r2.www + v6.xyz;
    r7.x = dot(r17.xyz, r17.xyz);
    r7.x = rsqrt(r7.x);
    r17.xyz = r17.xyz * r7.xxx;
    r18.xyz = v3.xyz * r2.www + v7.xyz;
    r2.w = dot(r18.xyz, r18.xyz);
    r2.w = rsqrt(r2.w);
    r18.xyz = r18.xyz * r2.www;
    r19.x = saturate(dot(r10.xyz, -v6.xyz));
    r19.y = saturate(dot(r10.xyz, -v7.xyz));
    r7.xz = log2(r19.xy);
    r7.xz = r7.xz * r0.zz;
    r7.xz = exp2(r7.xz);
    r7.xz = r7.xz * r6.ww;
    r10.x = dot(r4.xyz, r17.xyz);
    r10.y = dot(r4.xyz, r18.xyz);
    ...
    r0.z = r4.x * r5.x;
    r2.w = r4.y * r5.y;
    r4.xyz = r16.xyz * r2.www;
    r4.xyz = r14.xyz * r0.zzz + r4.xyz;
  ...
  r14.xyzw = int4(8192,64,512,0x8000) & asint(cb13[0].xxxx);
  r16.xyzw = r5.xyzw + r5.xyzw;
  r5.xyzw = r5.xyzw / cb1[0].zzzz;
  r5.xyzw = r14.xxxx ? r16.xyzw : r5.xyzw;
  ...
  r15.x = dot(cb2[84].xyzw, r3.xyzw);
  r15.y = dot(cb2[85].xyzw, r3.xyzw);
  r15.z = dot(cb2[86].xyzw, r3.xyzw);
  r15.w = dot(cb2[87].xyzw, r3.xyzw);
  r10.y = dot(r3.xyzw, r15.xyzw);
  r15.x = dot(cb2[88].xyzw, r3.xyzw);
  r15.y = dot(cb2[89].xyzw, r3.xyzw);
  r15.z = dot(cb2[90].xyzw, r3.xyzw);
  r15.w = dot(cb2[91].xyzw, r3.xyzw);
  ...
  r9.xyz = r14.yyy ? r9.xyz : r10.xyz;
  r2.w = saturate(-v2.z + r0.y);
  r3.w = 1 + -r2.w;
  r0.z = r0.z * r3.w + r2.w;
  r10.xyz = r13.xyz * r0.zzz;
  r10.xyz = r14.zzz ? r13.xyz : r10.xyz;
  ...
  r0.yzw = cb9[13].yyy * r12.xyz + r0.yzw;
  r2.w = r6.x * r6.x;
  r2.w = r2.w * r2.w;
  r2.w = r2.w * r6.x;
