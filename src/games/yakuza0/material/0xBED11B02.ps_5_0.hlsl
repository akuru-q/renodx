  ...
  out float4 o0 : SV_Target0)
{
  ...
  r4.w = v2.z * r4.w;
  r10.y = r4.w * 0.200000003 + 0.5;
  r4.w = t7.Sample(s7_s, r10.xy).x;
  ...
  r7.xyz = cb3[1].xyz * r3.yyy;
  r3.xyz = r3.xzw * r1.xxx + r7.xyz;
  ...
  r7.xyz = r6.zzz ? r7.xyz : float3(0,0,0);
  r5.xyw = t14.Sample(s14_s, r5.xy).xyz;
  r8.xyz = float3(4,4,4) * r5.xyw;
  r9.xyzw = int4(8192,0x8000,16,4) & asint(cb13[0].xxxx);
  r10.xyz = r5.xyw + r5.xyw;
  r5.xyw = r5.xyw / cb1[0].zzz;
  r5.xyw = r9.xxx ? r10.xyz : r5.xyw;
  r5.xyw = r6.www ? r8.xyz : r5.xyw;
  ...
  r6.xzw = max(float3(0.0625,0.0625,0.0625), r7.xyz);
  r2.w = saturate(dot(r2.xyz, -cb3[6].xyz));
  r2.x = saturate(dot(r2.xyz, -cb3[7].xyz));
  r2.y = r2.y * 0.5 + 0.5;
  r7.xyz = -cb3[10].xyz + cb3[4].xyz;
  r7.xyz = r2.yyy * r7.xyz + cb3[10].xyz;
  r6.xzw = cb2[79].xxx * r6.xzw + r7.xyz;
  r2.yzw = cb3[0].xyz * r2.www;
  r7.xyz = cb3[1].xyz * r2.xxx;
  r8.xyz = r2.yzw * r1.xxx + r7.xyz;
  ...
  r1.yzw = cb9[11].zzz * r4.xyz + r1.yzw;
