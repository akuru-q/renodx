  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.x = cb9[11].z * r1.x;
  r1.xyz = r1.xxx * r20.xyz + r1.yzw;
  r1.w = cb9[11].w * cb7[10].w;
  r1.xyz = r1.www * float3(0.00999999978,0.00999999978,0.00999999978) + r1.xyz;
  r1.xyz = cb9[12].xxx * r6.xyw + r1.xyz;
  r1.xyz = cb9[12].yyy * r7.xyz + r1.xyz;
  r1.xyz = cb9[12].zzz * r8.xyz + r1.xyz;
  r1.xyz = cb9[12].www + r1.xyz;
  r1.xyz = cb9[13].xxx * r16.xyz + r1.xyz;
  r1.xyz = cb9[13].yyy * r20.xyz + r1.xyz;
  r1.w = dot(-r3.yzw, r2.yzw);
  r1.w = 1 + -r1.w;
  r2.x = r1.w * r1.w;
  r2.x = r2.x * r2.x;
  r1.w = r2.x * r1.w;
  ...
  r1.xyz = cb9[13].www * cb1[13].xyz + r1.xyz;
  r1.xyz = cb9[14].xxx * r11.xyz + r1.xyz;
  r2.xyz = cb9[14].yyy * r16.xyz;
  r1.xyz = r2.xyz * r14.xyz + r1.xyz;
  r2.xyz = cb9[14].zzz * r16.xyz;
  r1.xyz = r2.xyz * r15.xyz + r1.xyz;
  r1.xyz = cb9[14].www * r12.xyz + r1.xyz;
  r2.xyz = cb9[15].xxx * r20.xyz;
  r1.xyz = r2.xyz * r17.xyz + r1.xyz;
  r2.xyz = cb9[15].yyy * r20.xyz;
  r2.xyz = r2.xyz * r18.xyz;
  r1.xyz = r2.xyz * r4.www + r1.xyz;
  r2.xyz = cb9[15].zzz * r13.xyz;
  r1.xyz = r2.xyz * r4.www + r1.xyz;
  r1.xyz = r10.yyy ? r1.xyz : r5.yzw;
  r2.xyz = r10.yyy ? float3(0,0,0) : r4.xyz;
  r1.xyz = r2.xyz + r1.xyz;
  r1.w = cb5[1].w * cb7[9].w;
  r1.w = cb6[0].w * r1.w;
  r2.w = r1.w * r0.w;
  r4.xyz = cb1[0].xxx * r1.xyz;

  MaterialPreTonemap(r4.xyz, cb1[0].x);

  r5.yzw = log2(r4.xyz);
  r5.yzw = cb1[0].yyy * r5.yzw;
  r5.yzw = exp2(r5.yzw);
  r6.xyz = r4.xyz + r4.xyz;
  r7.xyz = r4.xyz * float3(0.300000012,0.300000012,0.300000012) + float3(0.0500000007,0.0500000007,0.0500000007);
  r7.xyz = r6.xyz * r7.xyz + float3(0.00400000019,0.00400000019,0.00400000019);
  r4.xyz = r4.xyz * float3(0.300000012,0.300000012,0.300000012) + float3(0.5,0.5,0.5);
  r4.xyz = r6.xyz * r4.xyz + float3(0.0599999987,0.0599999987,0.0599999987);
  r4.xyz = r7.xyz / r4.xyz;
  r4.xyz = float3(-0.0666666701,-0.0666666701,-0.0666666701) + r4.xyz;
  r4.xyz = saturate(float3(1.37906432,1.37906432,1.37906432) * r4.xyz);

  MaterialPostTonemap(r4.xyz);

  r4.xyz = sqrt(r4.xyz);
  r1.xyz = r10.yyy ? r1.xyz : r4.xyz;
  r1.xyz = r10.zzz ? r5.yzw : r1.xyz;
  r4.xyz = v2.xyz + r1.xyz;
  r1.w = saturate(v2.x);
  r5.yzw = cb1[1].xyz + -r1.xyz;
  r1.xyz = r1.www * r5.yzw + r1.xyz;
  r1.xyz = r10.www ? r4.xyz : r1.xyz;
  r1.w = dot(v3.xyz, v3.xyz);
  r1.w = rsqrt(r1.w);
  r4.xyz = v3.xyz * r1.www;
  r1.w = dot(r3.yzw, r4.xyz);
  r3.x = -r1.w;
  r3.y = 0;
  r3.xy = v0.zw + r3.xy;
  r3.xyz = t6.Sample(s6_s, r3.xy).xyz;
  r0.xyz = log2(r0.xyz);
