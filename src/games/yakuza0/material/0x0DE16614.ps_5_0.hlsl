  ...
  out float4 o0 : SV_Target0)
{
  ...
  r3.w = dot(r9.xzw, r9.xzw);
  r3.w = rsqrt(r3.w);
  r9.xzw = r9.xzw * r3.www;
  ...
  r2.xyz = r12.xyz * r9.xzw + r2.xyz;
  r2.xyz = cb9[11].www * r5.xxx + r2.xyz;
  r2.w = cb9[12].y * r8.y;
  r2.xyz = cb9[12].xxx * r8.xxx + r2.xyz;
  r2.xyz = r2.www * r0.yyy + r2.xyz;
  r8.xyz = cb6[0].xyz * cb7[9].xyz;
  r2.xyz = cb9[13].xxx * r8.xyz + r2.xyz;
  r2.xyz = cb9[13].yyy * r9.xzw + r2.xyz;
  r0.y = r5.w * r5.w;
  r0.y = r0.y * r0.y;
  r0.y = r0.y * r5.w;
