  ...
  out float4 o0 : SV_Target0)
{
  ...
  r3.xy = cb7[5].zw * v0.zw;
  r3.xy = t6.Sample(s6_s, r3.xy).xy;
  r3.zw = t7.Sample(s7_s, v1.xy).xy;
  r2.xyz = -r2.xyz * r2.xyz + float3(1,1,1);
  r2.xyz = -r2.xyz * v3.www + float3(1,1,1);
  r0.xyz = r2.xyz * r0.xyz;
  r2.xy = float2(-0.5,-0.5) + r3.xy;
  r2.xy = v3.ww * r2.xy + float2(0.5,0.5);
  ...
  r3.x = saturate(dot(r4.xyz, -cb3[6].xyz));
  ...
  r3.y = r3.w * cb1[10].x + cb1[10].y;
  r3.y = r3.z * r3.y;
  r9.xyz = -cb3[5].xyz + float3(1,1,1);
  r10.xyz = r3.yyy * r9.xyz + cb3[5].xyz;
  ...
  r3.yw = r6.zw * cb1[9].xz + cb1[9].yw;
  r3.yw = r7.xx ? r3.yw : r8.xy;
  r3.y = r3.y * r3.w;
  r6.xyz = r3.yyy * r9.xyz + cb3[5].xyz;
  r8.xyw = v2.xyz * r10.xyz;
  r8.xyw = r8.xyw * r8.zzz;
  r9.xyz = r6.xyz * r10.xyz;
  r12.xyz = r6.xyz * cb1[11].xxx + cb1[11].yyy;
  ...
  r13.xyz = r11.xyz * r3.www + v6.xyz;
  r14.xyz = r11.www * r3.www + v7.xyz;
  r13.xyz = r7.www ? v6.xyz : r13.xyz;
  r14.xyz = r7.www ? v7.xyz : r14.xyz;
  r3.y = saturate(dot(r4.xyz, -cb3[7].xyz));
  r15.xyz = cb3[0].xyz * r3.xxx;
  r16.xyz = cb3[1].xyz * r3.yyy;
  r17.xyz = cb6[0].xyz * cb7[9].xyz;
  r18.xyz = r16.xyz * r3.www;
  r18.xyz = r15.xyz * r6.xyz + r18.xyz;
  r18.xyz = r17.xyz * r18.xyz + cb1[13].xyz;
  r10.xyz = r10.xyz * r0.xyz + r18.xyz;
  r18.xyz = r13.xyz * r9.xyz;
  r10.xyz = r10.xyz * r8.xyw + r18.xyz;
  r18.xyz = v5.xyz * r2.www + cb3[6].xyz;
  r3.x = dot(r18.xyz, r18.xyz);
  r3.x = rsqrt(r3.x);
  r18.xyz = r18.xyz * r3.xxx;
  r3.x = saturate(dot(-r18.xyz, r4.xyz));
  r18.xyz = v5.xyz * r2.www + float3(0,-0.300000012,0);
  ...
  r18.x = log2(r3.x);
  r18.y = log2(r2.w);
  r3.xz = cb7[10].ww * r18.xy;
  r3.xz = exp2(r3.xz);
  r2.w = cb3[11].x + cb3[11].x;
  r18.xyz = cb3[0].xyz * r3.xxx;
  r19.xyz = cb3[1].xyz * r3.zzz;
  r19.xyz = r19.xyz * r2.www;
  r20.xyz = r19.xyz * r3.yyy;
  r20.xyz = r18.xyz * r6.xyz + r20.xyz;
  r21.xyz = cb6[1].xyz * cb7[10].xyz;
  r20.xyz = r21.xyz * r20.xyz;
  r22.xyz = r14.xyz * r3.zzz;
  r22.xyz = r22.xyz * r9.xyz;
  r20.xyz = r20.xyz * r8.xyw + r22.xyz;
  r11.xyz = r11.xyz * r3.www + r10.xyz;
  r3.xyw = r11.www * r3.www + r20.xyz;
  r10.xyz = r7.www ? r11.xyz : r10.xyz;
  r3.xyw = r7.www ? r3.xyw : r20.xyz;
  r11.xyzw = int4(128,0x8000,16,4) & asint(cb13[0].xxxx);
  r3.xyw = r11.xxx ? float3(0,0,0) : r3.xyw;
  r7.yzw = r10.xyz * r0.xyz;
  r3.xyw = r3.xyw * r1.xyz;
  ...
  r0.xyz = cb9[12].xxx * r6.xyz + r0.xyz;
  ...
  r0.xyz = r1.xyz * r3.zzz + r0.xyz;
  r0.xyz = r11.yyy ? r0.xyz : r7.yzw;
  r1.xyz = r11.yyy ? float3(0,0,0) : r3.xyw;
