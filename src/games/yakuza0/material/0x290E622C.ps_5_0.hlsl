  ...
  out float4 o0 : SV_Target0)
{
  ...
  r7.xzw = cb9[4].www * r3.yzw;
  r7.xzw = r7.xzw * r3.xxx;
  ...
  r4.xyz = saturate(r7.xzw * cb3[0].xyz + r4.xyz);
  ...
  r0.xyz = cb9[12].xxx * r2.www + r0.xyz;
  r0.xyz = cb9[12].yyy + r0.xyz;
