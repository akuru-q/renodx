  ...
  out float4 o0 : SV_Target0)
{
  ...
  r5.w = dot(r11.xzw, r11.xzw);
  r5.w = rsqrt(r5.w);
  r11.xzw = r11.xzw * r5.www;
  ...
  r11.xzw = cb3[1].xyz * r5.yyy;
  r5.xyz = r5.xzw * r3.www + r11.xzw;
  r5.w = saturate(dot(r4.xyz, -v6.xyz));
  r12.x = v3.w;
  r12.y = v4.w;
  r12.z = v6.w;
  r11.xzw = r12.xyz * r5.www;
  ...
  r14.x = saturate(dot(-r14.xyz, r4.xyz));
  r14.y = saturate(dot(-r15.xyz, r4.xyz));
  r6.xw = log2(r14.xy);
  r6.xw = cb7[10].ww * r6.xw;
  r6.xw = exp2(r6.xw);
  r13.xyz = r13.xyz * r6.www;
  r12.xyz = r12.xyz * r6.xxx + r13.xyz;
  ...
  r12.xyz = cb3[0].xyz * r6.yyy;
  r6.xzw = cb3[1].xyz * r6.zzz;
  r13.xyz = r12.xyz * r3.www + r6.xzw;
  ...
  r9.xyz = r14.xyz * r7.xyz + r9.xyz;
  r9.xyz = cb9[11].www * r5.xxx + r9.xyz;
  r0.x = cb9[12].y * r2.z;
  r2.xzw = cb9[12].xxx * r2.xxx + r9.xyz;
  r0.xyz = r0.xxx * r0.yyy + r2.xzw;
  r2.xzw = cb6[0].xyz * cb7[9].xyz;
  r0.xyz = cb9[13].xxx * r2.xzw + r0.xyz;
  r0.xyz = cb9[13].yyy * r7.xyz + r0.xyz;
  r3.w = r2.y * r2.y;
  r3.w = r3.w * r3.w;
  r2.y = r3.w * r2.y;
