  ...
  out float4 o0 : SV_Target0)
{
  ...
  r3.xyz = -r3.xyz * v2.www + float3(1,1,1);
  ...
  r4.w = saturate(dot(r1.xyz, -cb3[7].xyz));
  ...
  r3.w = saturate(dot(-r4.xyz, r1.xyz));
  r10.x = log2(r1.w);
  r10.y = log2(r3.w);
  ...
  r3.xyz = r10.xzw * r3.xyz + r11.xyz;
  r10.xzw = cb6[1].xyz * cb7[10].xyz;
  r3.xyz = r10.xzw * r3.xyz;
  r10.xyz = v6.xyz * r10.yyy;
  r8.xyz = r10.xyz * r8.xyz;
  r3.xyz = r3.xyz * r6.xyz + r8.xyz;
  r6.xyz = r7.xyz * r5.yyy + r9.xyz;
  r3.xyz = r7.www * r5.yyy + r3.xyz;
  ...
  r3.xyzw = t2.Sample(s2_s, r1.xyz).xyzw;
  r1.x = max(0.00392156886, r3.w);
  r1.x = 0.25 / r1.x;
  r1.xyz = r3.xyz * r1.xxx;
  r1.xyz = r1.xyz * r1.xyz;
  r0.xyz = r1.xyz * r1.www + r0.xyz;
  r0.w = v1.w * r0.w;
  r2.w = cb5[1].w * cb7[9].w;
  r2.w = cb6[0].w * r2.w;
