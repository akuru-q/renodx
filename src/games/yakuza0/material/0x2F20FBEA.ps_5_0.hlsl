  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (r6.x != 0) {
    r7.xyz = t13.Sample(s13_s, r3.xy).xyw;
  } else {
    r7.xyz = float3(1,1,1);
  }
  ...
  r11.xyzw = t14.Sample(s14_s, r3.xy).xyzw;
  ...
  r3.xy = r8.xy * cb1[9].xz + cb1[9].yw;
  r3.xy = r6.xx ? r3.xy : r7.xy;
  r3.x = r3.x * r3.y;
  r7.xyw = r3.xxx * r9.xyz + cb3[5].xyz;
  ...
  r11.xyz = r11.xyz * r3.yyy + r13.xyz;
  r3.xyw = r11.www * r3.yyy + r22.xyz;
  r11.xyz = r6.www ? r11.xyz : r13.xyz;
  r3.xyw = r6.www ? r3.xyw : r22.xyz;
  r13.xyzw = int4(128,0x8000,16,4) & asint(cb13[0].xxxx);
  r3.xyw = r13.xxx ? float3(0,0,0) : r3.xyw;
  r11.xyz = r11.xyz * r0.xyz;
  r3.xyw = r3.xyw * r1.yyy;
  ...
  r1.yzw = r13.yyy ? float3(0,0,0) : r3.xyw;
  r0.xyz = r1.yzw + r0.xyz;
  r1.x = v4.w * r1.x;
  r1.yzw = r10.xyz * r3.zzz;
