  ...
  out float4 o0 : SV_Target0)
{
  ...
  r8.xyz = cb7[7].xxx * r8.xyz;
  r9.xy = cb7[6].xy * v2.xy;
  r9.xyzw = t7.Sample(s7_s, r9.xy).xyzw;
  r10.xyz = r9.xyz * r9.xyz;
  r9.xyz = -r9.xyz * r9.xyz + float3(1,1,1);
  r11.xy = float2(1,1) + -r0.zy;
  r9.xyz = r11.xxx * r9.xyz;
  r0.z = 1 + -r9.w;
  r9.xyz = r9.xyz * r0.zzz + r10.xyz;
  r1.xyz = r9.xyz * r1.xyz;
  r9.xyzw = r2.yxyz * r0.xxxx + float4(0.100000001,1,1,1);
  r9.x = saturate(r9.x);
  ...
  r0.x = r0.x * r0.z;
  r0.x = r0.x * r9.x;
  r10.xyzw = int4(4096,8,1,0x4000) & asint(cb13[0].xxxx);
  r0.z = cb9[9].w * r2.x;
  r0.z = exp2(r0.z);
  r0.z = cb9[9].z * r0.z;
  r0.z = r0.z * r9.x;
  r0.xz = r0.xz * r0.yy;
  r0.x = r10.x ? r0.z : r0.x;
  r0.x = r0.x * cb9[2].x + 1;
  ...
  r11.xz = r2.xz * cb1[12].xz + cb1[12].yw;
  r2.xz = r10.yy ? r11.xz : r2.xz;
  r2.x = min(r2.x, r2.z);
  r11.xzw = v3.xyz * r2.www + cb3[7].xyz;
  r2.z = dot(r11.xzw, r11.xzw);
  r2.z = rsqrt(r2.z);
  r11.xzw = r11.xzw * r2.zzz;
  r12.x = saturate(dot(r7.xyz, -cb3[6].xyz));
  r12.y = saturate(dot(r7.xyz, -cb3[7].xyz));
  r7.xy = log2(r12.xy);
  ...
  r6.y = dot(r5.xyz, r11.xzw);
  r5.xy = float2(1,1) + -r6.xy;
  r5.zw = r5.xy * r5.xy;
  r3.w = -cb7[8].z * cb1[0].w + 1;
  r5.zw = r5.zw * r5.zw;
  r5.zw = r5.zw * r3.ww;
  r5.xy = r5.zw * r5.xy + r2.zz;
  r5.xy = r7.xy * r5.xy;
  ...
  r7.xyz = cb3[0].xyz * r2.zzz;
  r11.xzw = cb3[1].xyz * r3.www;
  r7.xyz = r7.xyz * r2.xxx + r11.xzw;
  r2.z = saturate(dot(r4.xyz, -v6.xyz));
  r12.x = v3.w;
  r12.y = v4.w;
  r12.z = v6.w;
  r11.xzw = r12.xyz * r2.zzz;
  r11.xzw = max(float3(0,0,0), r11.xzw);
  r2.z = saturate(dot(r4.xyz, -v7.xyz));
  r13.x = v0.w;
  r13.y = v1.w;
  r13.z = v7.w;
  r14.xyz = r13.xyz * r2.zzz;
  r14.xyz = max(float3(0,0,0), r14.xyz);
  r11.xzw = r14.xyz + r11.xzw;
  r14.xyz = v3.xyz * r2.www + v6.xyz;
  r2.z = dot(r14.xyz, r14.xyz);
  r2.z = rsqrt(r2.z);
  r14.xyz = r14.xyz * r2.zzz;
  r15.xyz = v3.xyz * r2.www + v7.xyz;
  r2.z = dot(r15.xyz, r15.xyz);
  r2.z = rsqrt(r2.z);
  r15.xyz = r15.xyz * r2.zzz;
  r5.x = saturate(dot(-r14.xyz, r4.xyz));
  r5.y = saturate(dot(-r15.xyz, r4.xyz));
  r2.zw = log2(r5.xy);
  r2.zw = cb7[10].ww * r2.zw;
  r2.zw = exp2(r2.zw);
  r13.xyz = r13.xyz * r2.www;
  r12.xyz = r12.xyz * r2.zzz + r13.xyz;
  r12.xyz = max(float3(0,0,0), r12.xyz);
  r12.xyz = r12.xyz * r6.xyz;
  r12.xyz = min(float3(1,1,1), r12.xyz);
  r11.xzw = r10.zzz ? r11.xzw : float3(0,0,0);
  r12.xyz = r10.zzz ? r12.xyz : float3(0,0,0);
  r13.xyzw = t14.Sample(s14_s, r0.xz).xyzw;
  r14.xyzw = float4(4,4,4,4) * r13.xyzw;
  r15.xyzw = int4(8192,64,0x8000,16) & asint(cb13[0].xxxx);
  r16.xyzw = r13.xyzw + r13.xyzw;
  r13.xyzw = r13.xyzw / cb1[0].zzzz;
  r13.xyzw = r15.xxxx ? r16.xyzw : r13.xyzw;
  r13.xyzw = r10.wwww ? r14.xyzw : r13.xyzw;
  r10.xzw = r13.xyz + r11.xzw;
  r11.xzw = r13.www + r12.xyz;
  r4.w = 1;
  r12.x = dot(cb2[80].xyzw, r4.xyzw);
  r12.y = dot(cb2[81].xyzw, r4.xyzw);
  r12.z = dot(cb2[82].xyzw, r4.xyzw);
  r12.w = dot(cb2[83].xyzw, r4.xyzw);
  r12.x = dot(r4.xyzw, r12.xyzw);
  r13.x = dot(cb2[84].xyzw, r4.xyzw);
  r13.y = dot(cb2[85].xyzw, r4.xyzw);
  r13.z = dot(cb2[86].xyzw, r4.xyzw);
  r13.w = dot(cb2[87].xyzw, r4.xyzw);
  r12.y = dot(r4.xyzw, r13.xyzw);
  r13.x = dot(cb2[88].xyzw, r4.xyzw);
  r13.y = dot(cb2[89].xyzw, r4.xyzw);
  r13.z = dot(cb2[90].xyzw, r4.xyzw);
  r13.w = dot(cb2[91].xyzw, r4.xyzw);
  r12.z = dot(r4.xyzw, r13.xyzw);
  r4.xzw = max(float3(0.0625,0.0625,0.0625), r12.xyz);
  r0.x = r4.y * 0.5 + 0.5;
  r12.xyz = -cb3[10].xyz + cb3[4].xyz;
  r12.xyz = r0.xxx * r12.xyz + cb3[10].xyz;
  r4.xyz = cb2[79].xxx * r4.xzw + r12.xyz;
  r12.xyz = cb3[0].xyz * r5.zzz;
  r5.xyw = cb3[1].xyz * r5.www;
  r13.xyz = r12.xyz * r2.xxx + r5.xyw;
  r13.xyz = r13.xyz + r4.xyz;
  r13.xyz = r13.xyz + r10.xzw;
  r14.xyz = r13.xyz * r0.yyy;
  r0.x = r5.z * r2.x;
  r0.x = r0.x * r11.y + r0.y;
  r13.xyz = r13.xyz * r0.xxx;
  r13.xyz = r15.yyy ? r13.xyz : r14.xyz;
  r7.xyz = r6.xyz * r7.xyz + r11.xzw;
  r9.xyz = saturate(float3(0.5,0.5,0.5) * r9.yzw);
  r9.xyz = cb9[11].yyy * r9.xyz;
  r9.xyz = cb9[11].xxx * r1.xyz + r9.xyz;
  r14.xyz = cb9[11].zzz * r3.xyz;
  r9.xyz = r14.xyz * r6.xyz + r9.xyz;
  r9.xyz = cb9[11].www * r7.xxx + r9.xyz;
  r2.xzw = cb9[12].xxx * r2.xxx + r9.xyz;
  r0.xyz = cb9[12].yyy * r0.yyy + r2.xzw;
  r2.xzw = cb6[0].xyz * cb7[9].xyz;
  r0.xyz = cb9[13].xxx * r2.xzw + r0.xyz;
  ...
  r4.xyz = cb9[14].yyy * r2.xzw;
  r0.xyz = r4.xyz * r12.xyz + r0.xyz;
  r4.xyz = cb9[14].zzz * r2.xzw;
  r0.xyz = r4.xyz * r5.xyw + r0.xyz;
  r0.xyz = cb9[14].www * r10.xzw + r0.xyz;
  r4.xyz = cb9[15].xxx * r6.xyz;
  r0.xyz = r4.xyz * r7.xyz + r0.xyz;
  r4.xyz = cb9[15].yyy * r6.xyz;
  r0.xyz = r4.xyz * r7.xyz + r0.xyz;
  r0.xyz = saturate(cb9[15].zzz * r11.xzw + r0.xyz);
  r1.xyz = r13.xyz * r1.xyz;
  r3.xyz = r7.xyz * r3.xyz;
  r1.xyz = r1.xyz * r2.xzw + r3.xyz;
  r0.xyz = r15.zzz ? r0.xyz : r1.xyz;
  ...
  r2.xyz = sqrt(r2.xyz);
  r0.xyz = r15.zzz ? r0.xyz : r2.xyz;
  r0.xyz = r15.www ? r3.xyz : r0.xyz;
  ...
  r1.xyz = r15.zzz ? r2.xyz : r0.xyz;
  r0.xyzw = cb1[3].xyzw * r1.xyzw;
  o0.xyzw = r10.yyyy ? r1.xyzw : r0.xyzw;
  return;
}