  ...
  out float4 o0 : SV_Target0)
{
  ...
  r5.z = -0.5 + w2.x;
  r5.w = cmp(r5.z < 0);
  r7.xw = r5.ww ? float2(1,30) : 0;
  r5.z = r7.w + r5.z;
  r5.z = -1 + r5.z;
  r5.w = cmp(r5.z < 0);
  r9.xy = r5.ww ? float2(1,30) : 0;
  r10.xyzw = cb2[1].xyzw * r9.xxxx;
  r10.xyzw = cb2[0].xyzw * r7.xxxx + r10.xyzw;
  r5.z = r9.y + r5.z;
  r5.z = -1 + r5.z;
  r5.w = cmp(r5.z < 0);
  r7.xw = r5.ww ? float2(1,30) : 0;
  r9.xyzw = cb2[2].xyzw * r7.xxxx + r10.xyzw;
  r5.z = r7.w + r5.z;
  r5.z = -1 + r5.z;
  r5.w = cmp(r5.z < 0);
  r7.xw = r5.ww ? float2(1,30) : 0;
  r9.xyzw = cb2[3].xyzw * r7.xxxx + r9.xyzw;
  r5.z = r7.w + r5.z;
  r5.z = -1 + r5.z;
  r5.w = cmp(r5.z < 0);
  r7.xw = r5.ww ? float2(1,30) : 0;
  r9.xyzw = cb2[4].xyzw * r7.xxxx + r9.xyzw;
  r5.z = r7.w + r5.z;
  r5.z = -1 + r5.z;
  r5.w = cmp(r5.z < 0);
  r7.xw = r5.ww ? float2(1,30) : 0;
  r9.xyzw = cb2[5].xyzw * r7.xxxx + r9.xyzw;
  r5.z = r7.w + r5.z;
  r5.z = -1 + r5.z;
  r5.w = cmp(r5.z < 0);
  r7.xw = r5.ww ? float2(1,30) : 0;
  r9.xyzw = cb2[6].xyzw * r7.xxxx + r9.xyzw;
  r5.z = r7.w + r5.z;
  r5.z = -1 + r5.z;
  r5.w = cmp(r5.z < 0);
  r7.xw = r5.ww ? float2(1,30) : 0;
  r9.xyzw = cb2[7].xyzw * r7.xxxx + r9.xyzw;
  r5.z = r7.w + r5.z;
  r5.z = -1 + r5.z;
  r5.w = cmp(r5.z < 0);
  r7.xw = r5.ww ? float2(1,30) : 0;
  r9.xyzw = cb2[8].xyzw * r7.xxxx + r9.xyzw;
  r5.z = r7.w + r5.z;
  r5.z = -1 + r5.z;
  r5.z = cmp(r5.z < 0);
  r5.z = r5.z ? 1.000000 : 0;
  r9.xyzw = cb2[9].xyzw * r5.zzzz + r9.xyzw;
  r5.z = max(r1.x, r1.y);
  r5.z = max(r5.z, r1.z);
  r1.x = min(r1.x, r1.y);
  r1.x = min(r1.x, r1.z);
  ...
  if (r5.z != 0) {
    ...
    r8.w = r5.z + -r5.w;
    r9.y = 6 * r8.w;
    r10.xy = r9.yy * r7.xw + r5.ww;
    r11.xyzw = cmp(r7.xxxw < float4(0.166666672,0.5,0.666666687,0.166666672));
    r10.zw = float2(0.666666687,0.666666687) + -r7.xw;
    r10.zw = r10.zw * r8.ww;
    r10.zw = r10.zw * float2(6,6) + r5.ww;
    r7.x = r11.z ? r10.z : r5.w;
    r7.x = r11.y ? r5.z : r7.x;
    r1.x = r11.x ? r10.x : r7.x;
    r7.x = frac(r9.x);
    r9.x = r9.y * r7.x + r5.w;
    ...
    r7.x = r8.w * r7.x;
    r7.x = r7.x * 6 + r5.w;
    r7.x = r11.z ? r7.x : r5.w;
    r7.x = r11.y ? r5.z : r7.x;
    r1.y = r11.x ? r9.x : r7.x;
    r7.xw = cmp(r7.ww < float2(0.5,0.666666687));
    r5.w = r7.w ? r10.w : r5.w;
    r5.z = r7.x ? r5.z : r5.w;
    r1.z = r11.w ? r10.y : r5.z;
  }
