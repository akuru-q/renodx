  ...
  out float4 o0 : SV_Target0)
{
  ...
  r20.xyz = v5.xyz * r2.xxx + cb3[6].xyz;
  r3.w = dot(r20.xyz, r20.xyz);
  r3.w = rsqrt(r3.w);
  r20.xyz = r20.xyz * r3.www;
  r3.w = saturate(dot(-r20.xyz, r4.xyz));
  r20.xyz = v5.xyz * r2.xxx + float3(0,-0.300000012,0);
  r2.x = dot(r20.xyz, r20.xyz);
  r2.x = rsqrt(r2.x);
  r20.xyz = r20.xyz * r2.xxx;
  r2.x = saturate(dot(-r20.xyz, r4.xyz));
  r20.x = log2(r3.w);
  r20.y = log2(r2.x);
  ...
  r3.xyz = cb9[14].yyy * r19.xyz;
  r0.xyz = r3.xyz * r17.xyz + r0.xyz;
  r3.xyz = cb9[14].zzz * r19.xyz;
  r0.xyz = r3.xyz * r18.xyz + r0.xyz;
  r0.xyz = cb9[14].www * r15.xyz + r0.xyz;
  r3.xyz = cb9[15].xxx * r23.xyz;
  r0.xyz = r3.xyz * r20.xyz + r0.xyz;
  r3.xyz = cb9[15].yyy * r23.xyz;
  r3.xyz = r3.xyz * r21.xyz;
  r0.xyz = r3.xyz * r7.zzz + r0.xyz;
  r3.xyz = cb9[15].zzz * r16.xyz;
  r0.xyz = r3.xyz * r7.zzz + r0.xyz;
  r0.xyz = r22.yyy ? r0.xyz : r11.xyz;
  r3.xyz = r22.yyy ? float3(0,0,0) : r13.xyz;
