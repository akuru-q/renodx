  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.yz = cb7[5].xy * v0.zw;
  r1.y = t4.Sample(s4_s, r1.yz).y;
  ...
  r8.xyz = r1.www * r7.xyz + cb3[5].xyz;
  ...
  r1.w = r4.x * r4.y;
  r4.xzw = r1.www * r7.xyz + cb3[5].xyz;
  ...
  r1.z = saturate(dot(r2.xyz, -cb3[7].xyz));
  ...
  r1.yzw = v4.xyz * r1.yyy + float3(1,1,1);
