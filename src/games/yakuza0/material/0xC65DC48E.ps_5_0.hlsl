  ...
  out float4 o0 : SV_Target0)
{
  ...
  r4.xyz = t7.Sample(s7_s, v1.zw).xyz;
  r3.w = v3.w * r3.w;
  r3.w = r3.w * r4.z;
  ...
  r4.yw = r6.zw * cb1[9].xz + cb1[9].yw;
  r4.yw = r7.xx ? r4.yw : r8.xy;
  r4.y = r4.y * r4.w;
  r8.xyw = r4.yyy * r9.xyz + cb3[5].xyz;
  ...
  r20.xyz = v5.xyz * r3.www + cb3[6].xyz;
  r5.w = dot(r20.xyz, r20.xyz);
  r5.w = rsqrt(r5.w);
  r20.xyz = r20.xyz * r5.www;
  r5.w = saturate(dot(-r20.xyz, r3.xyz));
  r20.xyz = v5.xyz * r3.www + float3(0,-0.300000012,0);
  r3.w = dot(r20.xyz, r20.xyz);
  r3.w = rsqrt(r3.w);
  r20.xyz = r20.xyz * r3.www;
  r3.w = saturate(dot(-r20.xyz, r3.xyz));
  r6.x = log2(r5.w);
  r6.y = log2(r3.w);
  ...
  r11.xyz = r11.xyz * r4.www + r13.xyz;
  r24.xyz = r11.www * r4.www + r22.xyz;
  ...
  r1.xyz = r13.yyy ? float3(0,0,0) : r7.yzw;
  ...
  r2.w = r6.z * r6.w;
  r4.x = saturate(0.75 + r4.z);
  r2.w = r4.x * r2.w;
  r2.w = max(cb3[11].y, r2.w);
  r3.w = max(0.00392156886, r3.w);
  r3.w = 0.25 / r3.w;
