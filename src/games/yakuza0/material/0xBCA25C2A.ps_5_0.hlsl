  ...
  out float4 o0 : SV_Target0)
{
  ...
  r10.xyz = r10.xyz * r2.zzz + r12.xyz;
  ...
  r8.xyz = r12.xyz * r6.xyz + r8.xyz;
  r8.xyz = cb9[11].www * r7.xxx + r8.xyz;
  r2.xzw = cb9[12].xxx * r2.xxx + r8.xyz;
  r2.xzw = cb9[12].yyy * r0.yyy + r2.xzw;
  r8.xyz = cb6[0].xyz * cb7[9].xyz;
  r2.xzw = cb9[13].xxx * r8.xyz + r2.xzw;
  r2.xzw = cb9[13].yyy * r6.xyz + r2.xzw;
  r0.y = r2.y * r2.y;
  r0.y = r0.y * r0.y;
  r0.y = r0.y * r2.y;
