  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (r7.y != 0) {
    r8.xy = t13.Sample(s13_s, r0.xz).xy;
  } else {
    r8.xy = float2(1,1);
  }
  ...
  r3.w = r3.w + r3.w;
  r9.xzw = r4.xyz * -r3.www + r5.xyz;
  r10.x = saturate(dot(r9.xzw, -cb3[6].xyz));
  r10.y = saturate(dot(r9.xzw, -cb3[7].xyz));
  r9.xz = log2(r10.xy);
  r9.xz = cb7[10].ww * r9.xz;
  r9.xz = exp2(r9.xz);
  r3.w = cb1[0].w * cb7[8].z;
  r6.w = cb7[10].w * 0.0397435986 + 0.0856831968;
  r9.xz = r9.xz * r6.ww;
  r6.x = dot(r5.xyz, r6.xyz);
  r6.y = dot(r5.xyz, r8.xyz);
  r5.xy = float2(1,1) + -r6.xy;
  r6.xy = r5.xy * r5.xy;
  r5.z = -cb7[8].z * cb1[0].w + 1;
  r6.xy = r6.xy * r6.xy;
  r6.xy = r6.xy * r5.zz;
  r5.xy = r6.xy * r5.xy + r3.ww;
  r5.xy = r9.xz * r5.xy;
  ...
  r9.xzw = cb3[0].xyz * r3.www;
  r5.xyz = cb3[1].xyz * r5.xxx;
  r5.xyz = r9.xzw * r2.xxx + r5.xyz;
  r3.w = saturate(dot(r4.xyz, -v6.xyz));
  r10.x = v3.w;
  r10.y = v4.w;
  r10.z = v6.w;
  r9.xzw = r10.xyz * r3.www;
  r9.xzw = max(float3(0,0,0), r9.xzw);
  ...
  r12.x = saturate(dot(-r12.xyz, r4.xyz));
  r12.y = saturate(dot(-r13.xyz, r4.xyz));
  r6.xw = log2(r12.xy);
  r6.xw = cb7[10].ww * r6.xw;
  r6.xw = exp2(r6.xw);
  r11.xyz = r11.xyz * r6.www;
  r10.xyz = r10.xyz * r6.xxx + r11.xyz;
  r10.xyz = max(float3(0,0,0), r10.xyz);
  r10.xyz = r10.xyz * r8.xyz;
  r10.xyz = min(float3(1,1,1), r10.xyz);
  r9.xzw = r7.zzz ? r9.xzw : float3(0,0,0);
  r10.xyz = r7.zzz ? r10.xyz : float3(0,0,0);
  r11.xyzw = t14.Sample(s14_s, r0.xz).xyzw;
  ...
  r0.xzw = r11.xyz + r9.xzw;
  r7.xzw = r11.www + r10.xyz;
  r4.w = 1;
  ...
  r3.w = r4.y * 0.5 + 0.5;
  r9.xzw = -cb3[10].xyz + cb3[4].xyz;
  r9.xzw = r3.www * r9.xzw + cb3[10].xyz;
  r4.xyz = cb2[79].xxx * r4.xzw + r9.xzw;
  r9.xzw = cb3[0].xyz * r6.yyy;
  r6.xzw = cb3[1].xyz * r6.zzz;
  r10.xyz = r9.xzw * r2.xxx + r6.xzw;
  ...
  r5.xyz = r8.xyz * r5.xyz + r7.xzw;
  r2.yzw = saturate(float3(0.5,0.5,0.5) * r2.yzw);
  r2.yzw = cb9[11].yyy * r2.yzw;
  r2.yzw = cb9[11].xxx * r1.xyz + r2.yzw;
  r11.xyz = cb9[11].zzz * r3.xyz;
  r2.yzw = r11.xyz * r8.xyz + r2.yzw;
  r2.yzw = cb9[11].www * r5.xxx + r2.yzw;
  r2.xyz = cb9[12].xxx * r2.xxx + r2.yzw;
  r2.xyz = cb9[12].yyy * r0.yyy + r2.xyz;
  r11.xyz = cb6[0].xyz * cb7[9].xyz;
  r2.xyz = cb9[13].xxx * r11.xyz + r2.xyz;
  r2.xyz = cb9[13].yyy * r8.xyz + r2.xyz;
  r0.y = r5.w * r5.w;
  r0.y = r0.y * r0.y;
  r0.y = r0.y * r5.w;
  r0.y = r0.y * 0.972222209 + 0.027777778;
  r2.xyz = cb9[13].zzz * r0.yyy + r2.xyz;
  r2.xyz = cb9[13].www * r4.xyz + r2.xyz;
  r4.xyz = cb9[14].yyy * r11.xyz;
  r2.xyz = r4.xyz * r9.xzw + r2.xyz;
  r4.xyz = cb9[14].zzz * r11.xyz;
  r2.xyz = r4.xyz * r6.xzw + r2.xyz;
  r0.xyz = cb9[14].www * r0.xzw + r2.xyz;
