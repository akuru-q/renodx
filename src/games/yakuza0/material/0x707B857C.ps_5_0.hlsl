  ...
  out float4 o0 : SV_Target0)
{
  ...
  r10.xyz = v5.yzx * r3.zxy;
  r10.xyz = r3.yzx * v5.zxy + -r10.xyz;
  r10.xyz = v5.www * r10.xyz;
  r11.xyz = r10.zxy * r3.yzx;
  r11.xyz = r10.yzx * r3.zxy + -r11.xyz;
  r12.x = dot(r3.xyz, -r5.xyz);
  r2.w = dot(-r5.xyz, r10.xyz);
  r2.w = v2.z * r2.w;
  r12.y = r2.w * 0.200000003 + 0.5;
  r2.w = t7.Sample(s7_s, r12.xy).x;
  r4.w = dot(-r5.xyz, r11.xyz);
  r4.w = v2.w * r4.w;
  r12.z = r4.w * 0.200000003 + 0.5;
  r4.w = t7.Sample(s7_s, r12.xz).x;
  r2.w = r4.w * r2.w;
  r12.x = dot(r3.xyz, -r9.xyz);
  r4.w = dot(-r9.xyz, r10.xyz);
  r4.w = v2.z * r4.w;
  r12.y = r4.w * 0.200000003 + 0.5;
  r4.w = t7.Sample(s7_s, r12.xy).x;
  r5.w = dot(-r9.xyz, r11.xyz);
  r5.w = v2.w * r5.w;
  r12.z = r5.w * 0.200000003 + 0.5;
  r5.w = t7.Sample(s7_s, r12.xz).x;
  r4.w = r5.w * r4.w;
  r10.x = log2(r2.w);
  r10.y = log2(r4.w);
  r8.zw = r10.xy * r0.zz;
  ...
  r2.xyw = t14.Sample(s14_s, r2.xy).xyz;
  r10.xyz = float3(4,4,4) * r2.xyw;
  r11.xyzw = int4(8192,64,0x8000,16) & asint(cb13[0].xxxx);
  r12.xyz = r2.xyw + r2.xyw;
  r2.xyw = r2.xyw / cb1[0].zzz;
  r2.xyw = r11.xxx ? r12.xyz : r2.xyw;
  r2.xyw = r7.www ? r10.xyz : r2.xyw;
  ...
  r7.xzw = max(float3(0.0625,0.0625,0.0625), r9.xyz);
  r0.z = saturate(dot(r3.xyz, -cb3[6].xyz));
  r3.x = saturate(dot(r3.xyz, -cb3[7].xyz));
  r3.y = r3.y * 0.5 + 0.5;
  r9.xyz = -cb3[10].xyz + cb3[4].xyz;
  r3.yzw = r3.yyy * r9.xyz + cb3[10].xyz;
  r3.yzw = cb2[79].xxx * r7.xzw + r3.yzw;
  r7.xzw = cb3[0].xyz * r0.zzz;
  r9.xyz = cb3[1].xyz * r3.xxx;
  r10.xyz = r7.xzw * r0.www + r9.xyz;
  r10.xyz = r10.xyz + r3.yzw;
  ...
  r0.yzw = cb9[13].www * r3.yzw + r0.yzw;
  ...
  r0.yzw = saturate(r2.xyz * r4.xyz + r0.yzw);
