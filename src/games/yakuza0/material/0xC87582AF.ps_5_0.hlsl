  ...
  out float4 o0 : SV_Target0)
{
  ...
  r6.yzw = r5.www * r6.yzw + cb3[10].xyz;
  r5.xyz = cb2[79].xxx * r5.xyz + r6.yzw;
  r6.yzw = cb3[0].xyz * r2.www;
  r8.xyz = cb3[1].xyz * r4.www;
  r9.xyz = r6.yzw * r3.www + r8.xyz;
  r9.xyz = r9.xyz + r5.xyz;
  r9.xyz = r9.xyz + r4.xyz;
  r2.w = max(r9.x, r9.y);
  r2.w = max(r2.w, r9.z);
  r2.w = saturate(cb9[6].z + r2.w);
  r10.xyw = r3.yzx * r2.www;
  r3.xyz = int3(0x8000,16,4) & asint(cb13[0].xxx);
  ...
  r11.xyz = cb9[11].zzz * r7.xyz + r11.xyz;
  ...
  r11.xyz = cb9[13].yyy * r7.xyz + r11.xyz;
