  ...
  out float4 o0 : SV_Target0)
{
  ...
  r4.w = r5.x * r5.y;
  r7.xyw = r4.www * r8.xyz + cb3[5].xyz;
  ...
  r4.xyzw = t6.Sample(s6_s, r2.xyw).xyzw;
  r2.x = r5.z * r5.w;
  r2.y = saturate(0.75 + r3.w);
  r2.x = r2.x * r2.y;
  r2.x = max(cb3[11].y, r2.x);
  r2.y = max(0.00392156886, r4.w);
  r2.y = 0.25 / r2.y;
  r3.xyz = r4.xyz * r2.yyy;
