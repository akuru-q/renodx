  ...
  out float4 o0 : SV_Target0)
{
  ...
  r3.x = t2.Sample(s2_s, v1.xy).y;
  r3.yz = t7.Sample(s7_s, v1.zw).xy;
  r2.w = v3.w * r2.w;
  r2.w = r2.w * r3.x;
  r1.w = 1 + -r1.w;
  r1.w = -r1.w * r2.w + 1;
  ...
  r1.w = max(0, r1.w);
  r1.w = sqrt(r1.w);
  r2.x = r3.z * cb1[10].x + cb1[10].y;
  r2.x = r3.y * r2.x;
  r2.yzw = -cb3[5].xyz + float3(1,1,1);
  r3.xzw = r2.xxx * r2.yzw + cb3[5].xyz;
  ...
  r6.xyw = v2.xyz * r3.xzw;
  r6.xyz = r6.xyw * r6.zzz;
  r8.xyz = r2.yzw * r3.xzw;
  r9.xyz = r2.yzw * cb1[11].xxx + cb1[11].yyy;
  r3.xzw = r3.xzw * cb1[11].zzz + cb1[11].www;
  r3.xzw = r9.xyz * r3.xzw;
  r3.xzw = r5.zzz ? r3.xzw : r8.xyz;
