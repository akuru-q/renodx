  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.x = rsqrt(r1.x);
  r4.xyz = r3.yxz * r1.xxx;
  r1.y = dot(v5.xyz, v5.xyz);
  r1.y = rsqrt(r1.y);
  r5.xyz = v5.xyz * r1.yyy;
  r2.w = saturate(dot(r4.yxz, -cb3[6].xyz));
  ...
  r1.xyw = cb9[14].yyy * r17.xyz;
  r0.xyz = r1.xyw * r15.xyz + r0.xyz;
  r1.xyw = cb9[14].zzz * r17.xyz;
  r0.xyz = r1.xyw * r16.xyz + r0.xyz;
  r0.xyz = cb9[14].www * r13.xyz + r0.xyz;
  r1.xyw = cb9[15].xxx * r21.xyz;
  r0.xyz = r1.xyw * r18.xyz + r0.xyz;
  r1.xyw = cb9[15].yyy * r21.xyz;
  r1.xyw = r1.xyw * r19.xyz;
  r0.xyz = r1.xyw * r7.zzz + r0.xyz;
  r1.xyw = cb9[15].zzz * r14.xyz;
  r0.xyz = r1.xyw * r7.zzz + r0.xyz;
  r0.xyz = r20.yyy ? r0.xyz : r10.yzw;
  r1.xyw = r20.yyy ? float3(0,0,0) : r11.xyz;
  r0.xyz = r1.xyw + r0.xyz;
  r1.x = v4.w * r2.x;
  r1.x = r1.x * r10.x;
  r1.x = r1.x * r1.z;
  r1.y = dot(r5.yxz, r4.xyz);
  r1.y = r1.y + r1.y;
  r1.yzw = r4.yxz * -r1.yyy + r5.xyz;
  r2.xy = cb9[1].ww * r1.yw;
  r2.w = max(0.00999999978, r4.x);
  r2.xy = r2.xy / r2.ww;
  r2.xy = cb9[1].xz + r2.xy;
  r3.xyzw = t4.Sample(s4_s, r2.xy).xyzw;
  r2.x = max(0.00392156886, r3.w);
  r2.x = 0.25 / r2.x;
  r2.xyw = r3.xyz * r2.xxx;
  r2.xyw = r2.xyw * r2.xyw;
  r2.xyw = r2.xyw * r1.xxx;
  r3.x = saturate(r4.x);
  r0.xyz = r2.xyw * r3.xxx + r0.xyz;
  r1.yzw = float3(-1,1,1) * r1.yzw;
  r3.xyzw = t6.Sample(s6_s, r1.yzw).xyzw;
  r1.y = max(0.00392156886, r3.w);
  r1.y = 0.25 / r1.y;
