  ...
  out float4 o0 : SV_Target0)
{
  ...
  r3.w = r4.x * r4.y;
  r4.xzw = r3.www * r7.xyz + cb3[5].xyz;
  ...
  r3.w = saturate(dot(r2.xyz, -cb3[7].xyz));
  r13.xyz = cb3[0].xyz * r2.www;
  r14.xyz = cb3[1].xyz * r3.www;
  ...
  r16.xyz = v4.xyz * r1.www + cb3[6].xyz;
  r2.w = dot(r16.xyz, r16.xyz);
  r2.w = rsqrt(r2.w);
  r16.xyz = r16.xyz * r2.www;
  r2.w = saturate(dot(-r16.xyz, r2.xyz));
  r16.xyz = v4.xyz * r1.www + float3(0,-0.300000012,0);
  ...
  r9.xyz = r5.www ? r20.xyz : r18.xyz;
  r18.xyzw = int4(128,0x8000,16,4) & asint(cb13[0].xxxx);
  r9.xyz = r18.xxx ? float3(0,0,0) : r9.xyz;
  r8.xyz = r8.xyz * r0.xyz;
  r9.xyz = r9.xyz * r1.xxx;
  r20.xyz = v3.xyz * r1.zzz + float3(1,1,1);
  ...
  r1.xzw = cb9[15].zzz * r12.xyz;
  r0.xyz = r1.xzw * r5.zzz + r0.xyz;
  r0.xyz = r18.yyy ? r0.xyz : r8.xyz;
  r1.xzw = r18.yyy ? float3(0,0,0) : r9.xyz;
  r0.xyz = r1.xzw + r0.xyz;
  r1.x = r1.y * r0.w;
  r1.z = cb5[1].w * cb7[9].w;
  r1.z = cb6[0].w * r1.z;
  r2.w = r1.x * r1.z;
  r1.xzw = cb1[0].xxx * r0.xyz;

  MaterialPreTonemap(r1.xzw, cb1[0].x);

  r3.xyz = log2(r1.xzw);
  r3.xyz = cb1[0].yyy * r3.xyz;
  r3.xyz = exp2(r3.xyz);
  r4.xyz = r1.xzw + r1.xzw;
  r5.yzw = r1.xzw * float3(0.300000012,0.300000012,0.300000012) + float3(0.0500000007,0.0500000007,0.0500000007);
  r5.yzw = r4.xyz * r5.yzw + float3(0.00400000019,0.00400000019,0.00400000019);
  r1.xzw = r1.xzw * float3(0.300000012,0.300000012,0.300000012) + float3(0.5,0.5,0.5);
  r1.xzw = r4.xyz * r1.xzw + float3(0.0599999987,0.0599999987,0.0599999987);
  r1.xzw = r5.yzw / r1.xzw;
  r1.xzw = float3(-0.0666666701,-0.0666666701,-0.0666666701) + r1.xzw;
  r1.xzw = saturate(float3(1.37906432,1.37906432,1.37906432) * r1.xzw);

  MaterialPostTonemap(r1.xzw);

  r1.xzw = sqrt(r1.xzw);
  r0.xyz = r18.yyy ? r0.xyz : r1.xzw;
  r0.xyz = r18.zzz ? r3.xyz : r0.xyz;
  r1.xzw = v2.xyz + r0.xyz;
  r3.x = saturate(v2.x);
  r3.yzw = cb1[1].xyz + -r0.xyz;
  r0.xyz = r3.xxx * r3.yzw + r0.xyz;
  r2.xyz = r18.www ? r1.xzw : r0.xyz;
  r0.x = r0.w * r1.y + -cb7[8].x;
  r0.x = cmp(r0.x < 0);
  if (r0.x != 0) discard;
