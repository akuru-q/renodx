  ...
  out float4 o0 : SV_Target0)
{
  ...
  r6.xyzw = r7.wwww ? r12.xyzw : r6.xyzw;
  r6.xyzw = r7.zzzz ? r11.xyzw : r6.xyzw;
  r6.xyz = r10.xyz + r6.xyz;
  r7.yzw = r9.xyz + r6.www;
  r1.w = 1;
  ...
  r11.xyz = r3.xyz * r0.www + r10.xyz;
  r11.xyz = r11.xyz + r9.xyz;
  r11.xyz = r11.xyz + r6.xyz;
  r8.xyw = r4.yzx * r8.yzx + r7.zwy;
  r12.xyz = int3(0x8000,16,4) & asint(cb13[0].xxx);
  r13.xyz = v4.xyz * r0.yyy + float3(1,1,1);
  r13.xyz = saturate(float3(0.5,0.5,0.5) * r13.xyz);
  r13.xyz = cb9[11].yyy * r13.xyz;
  r13.xyz = cb9[11].xxx * r5.xyz + r13.xyz;
  r13.xyz = cb9[11].zzz * r4.xyz + r13.xyz;
  r13.xyz = cb9[11].www * r8.www + r13.xyz;
  r0.yzw = cb9[12].xxx * r0.www + r13.xyz;
  r0.yzw = cb9[12].yyy + r0.yzw;
  ...
  r0.yzw = r1.xyz * r10.xyz + r0.yzw;
  r0.yzw = cb9[14].www * r6.xyz + r0.yzw;
  r1.xyz = cb9[15].xxx * r4.xyz;
  r0.yzw = r1.xyz * r8.wxy + r0.yzw;
  r1.xyz = cb9[15].yyy * r4.xyz;
  r0.yzw = r1.xyz * r8.wxy + r0.yzw;
  r1.xyz = saturate(cb9[15].zzz * r7.yzw + r0.yzw);
  r0.yzw = r11.xyz * r5.xyz;
  r8.xyz = r0.yzw * r13.xyz + r8.wxy;
  r1.w = 1;
  r1.xyzw = r12.xxxx ? r1.wxyz : r8.wxyz;
  r0.y = cb5[1].w * cb7[9].w;
  r0.y = cb6[0].w * r0.y;
  r0.z = r0.x * r0.y;
  r0.x = -r0.x * r0.y + 1;
  r1.x = saturate(r1.x);
