  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.xyz = v3.xyz * r1.xyz;
  r3.xyz = int3(8,16,0x8000) & asint(cb13[0].xxx);
  if (r3.x != 0) {
    r4.xy = v2.xy / v2.ww;
  ...
  r4.zw = r4.xy * cb1[9].xz + cb1[9].yw;
  r4.xy = r3.xx ? r4.zw : r4.xy;
  r1.w = r4.x * r4.y;
  r4.xyz = -cb3[5].xyz + float3(1,1,1);
  r4.xyz = r1.www * r4.xyz + cb3[5].xyz;
  r4.xyz = r3.xxx ? r4.xyz : float3(1,1,1);
  r1.xyz = cb9[0].xyz * r1.xyz;
