  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.w = saturate(dot(r5.xyz, -cb3[6].xyz));
  r3.zw = cb12[29].zw * v9.xy;
  r7.xyzw = int4(8,0x4000,8192,2048) & asint(cb13[0].xxxx);
  if (r7.x != 0) {
    r8.xyz = t13.Sample(s13_s, r3.zw).xyw;
  } else {
    r8.xyz = float3(1,1,1);
  }
  r9.xy = r8.xy * cb1[9].xz + cb1[9].yw;
  r9.xy = r7.xx ? r9.xy : r8.xy;
  r3.y = r3.y * cb1[10].x + cb1[10].y;
  r3.y = r3.x * r3.y;
  r10.xyz = -cb3[5].xyz + float3(1,1,1);
  r11.xyz = r3.yyy * r10.xyz + cb3[5].xyz;
  r12.xyzw = t14.Sample(s14_s, r3.zw).xyzw;
  r13.xyzw = r12.xyzw + r12.xyzw;
  r12.xyzw = r12.xyzw / cb1[0].zzzz;
  r12.xyzw = r7.zzzz ? r13.xyzw : r12.xyzw;
  r12.xyzw = r7.yyyy ? r13.xyzw : r12.xyzw;
  r3.yz = r9.xy * cb1[9].xz + cb1[9].yw;
  r3.yz = r7.xx ? r3.yz : r8.xy;
  r3.y = r3.y * r3.z;
  r8.xyw = r3.yyy * r10.xyz + cb3[5].xyz;
  r9.xyz = v2.xyz * r11.xyz;
  r9.xyz = r9.xyz * r8.zzz;
  r10.xyz = r8.xyw * r11.xyz;
  r13.xyz = r8.xyw * cb1[11].xxx + cb1[11].yyy;
  r11.xyz = r11.xyz * cb1[11].zzz + cb1[11].www;
  r11.xyz = r13.xyz * r11.xyz;
  r10.xyz = r7.xxx ? r11.xyz : r10.xyz;
  r3.xyw = r10.xyz * r3.xxx;
  r3.xyw = r3.xyw * r8.zzz;
  r10.xyz = cb6[1].www * cb7[11].xyz;
  r11.xyz = r10.xyz * r0.xyz;
  r13.xyz = r12.xyz * r3.zzz + v6.xyz;
  r14.xyz = r12.www * r3.zzz + v7.xyz;
  r13.xyz = r7.www ? v6.xyz : r13.xyz;
  r14.xyz = r7.www ? v7.xyz : r14.xyz;
  r4.w = saturate(dot(r5.xyz, -cb3[7].xyz));
  r15.xyz = cb3[0].xyz * r2.www;
  r16.xyz = cb3[1].xyz * r4.www;
  r17.xyz = cb6[0].xyz * cb7[9].xyz;
  r18.xyz = r16.xyz * r3.zzz;
  r18.xyz = r15.xyz * r8.xyw + r18.xyz;
  r18.xyz = r17.xyz * r18.xyz + cb1[13].xyz;
  r10.xyz = r10.xyz * r0.xyz + r18.xyz;
  r18.xyz = r13.xyz * r3.xyw;
  r10.xyz = r10.xyz * r9.xyz + r18.xyz;
  r18.xyz = v5.xyz * r1.zzz + cb3[6].xyz;
  r2.w = dot(r18.xyz, r18.xyz);
  r2.w = rsqrt(r2.w);
  r18.xyz = r18.xyz * r2.www;
  r2.w = saturate(dot(-r18.xyz, r5.xyz));
  r18.xyz = v5.xyz * r1.zzz + float3(0,-0.300000012,0);
  r1.z = dot(r18.xyz, r18.xyz);
  r1.z = rsqrt(r1.z);
  r18.xyz = r18.xyz * r1.zzz;
  r1.z = saturate(dot(-r18.xyz, r5.xyz));
  r18.x = log2(r2.w);
  r18.y = log2(r1.z);
  r7.yz = cb7[10].ww * r18.xy;
  r7.yz = exp2(r7.yz);
  r1.z = cb3[11].x + cb3[11].x;
  r18.xyz = cb3[0].xyz * r7.yyy;
  r19.xyz = cb3[1].xyz * r7.zzz;
  r19.xyz = r19.xyz * r1.zzz;
  r20.xyz = r19.xyz * r4.www;
  r20.xyz = r18.xyz * r8.xyw + r20.xyz;
  r21.xyz = cb6[1].xyz * cb7[10].xyz;
  r20.xyz = r21.xyz * r20.xyz;
  r22.xyz = r14.xyz * r7.zzz;
  r22.xyz = r22.xyz * r3.xyw;
  r20.xyz = r20.xyz * r9.xyz + r22.xyz;
  r12.xyz = r12.xyz * r3.zzz + r10.xyz;
  r22.xyz = r12.www * r3.zzz + r20.xyz;
  r10.xyz = r7.www ? r12.xyz : r10.xyz;
  r12.xyz = r7.www ? r22.xyz : r20.xyz;
  r20.xyzw = int4(128,0x8000,16,4) & asint(cb13[0].xxxx);
  r12.xyz = r20.xxx ? float3(0,0,0) : r12.xyz;
  r10.xyz = r10.xyz * r0.xyz;
  r12.xyz = r12.xyz * r1.xxx;
  r4.xyz = r4.xyz * r1.yyy + float3(1,1,1);
  ...
  r0.xyz = cb9[12].zzz * r3.xyw + r0.xyz;
  ...
  r1.xyz = r20.yyy ? float3(0,0,0) : r12.xyz;
