  ...
  out float4 o0 : SV_Target0)
{
  ...
  r15.xyz = r11.xyz * r2.www + v5.xyz;
  r16.xyz = r11.www * r2.www + v6.xyz;
  ...
  r4.x = r6.z * r6.w;
  r2.z = saturate(0.75 + r2.z);
  r2.z = r4.x * r2.z;
  r2.z = max(cb3[11].y, r2.z);
