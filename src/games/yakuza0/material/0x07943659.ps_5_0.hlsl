  ...
  out float4 o0 : SV_Target0)
{
  ...
  r8.w = cb7[10].w * 0.0397435986 + 0.0856831968;
  r9.xy = r9.xy * r8.ww;
  ...
  r8.xy = r8.xy * r8.xy;
  r8.xy = r8.xy * r5.zz;
  r5.xy = r8.xy * r5.xy + r5.ww;
  r5.xy = r9.xy * r5.xy;
  r8.x = dot(r3.xyz, -cb3[6].xyz);
  r5.z = saturate(r8.x);
  r5.x = r5.x * r5.z;
  r8.y = dot(r3.xyz, -cb3[7].xyz);
  r8.xyz = saturate(r8.yxy);
  r5.y = r8.x * r5.y;
  r9.xyz = cb6[1].xyz * cb7[10].xyz;
  r5.xzw = cb3[0].xyz * r5.xxx;
  r10.xyz = cb3[1].xyz * r5.yyy;
  r5.xyz = r5.xzw * r4.www + r10.xyz;
  ...
  r8.xw = log2(r13.xy);
  r8.xw = cb7[10].ww * r8.xw;
  r8.xw = exp2(r8.xw);
  r12.xyz = r12.xyz * r8.www;
  r10.xyz = r10.xyz * r8.xxx + r12.xyz;
  ...
  r12.xyzw = t14.Sample(s14_s, r6.xy).xyzw;
  r13.xyzw = float4(4,4,4,4) * r12.xyzw;
  r14.xyzw = r12.xyzw + r12.xyzw;
  r12.xyzw = r12.xyzw / cb1[0].zzzz;
  r12.xyzw = r7.wwww ? r14.xyzw : r12.xyzw;
  r12.xyzw = r7.zzzz ? r13.xyzw : r12.xyzw;
  r7.yzw = r12.xyz + r11.xyz;
  ...
  r11.x = dot(r3.xyzw, r11.xyzw);
  r12.x = dot(cb2[84].xyzw, r3.xyzw);
  r12.y = dot(cb2[85].xyzw, r3.xyzw);
  r12.z = dot(cb2[86].xyzw, r3.xyzw);
  r12.w = dot(cb2[87].xyzw, r3.xyzw);
  r11.y = dot(r3.xyzw, r12.xyzw);
  r12.x = dot(cb2[88].xyzw, r3.xyzw);
  r12.y = dot(cb2[89].xyzw, r3.xyzw);
  r12.z = dot(cb2[90].xyzw, r3.xyzw);
  r12.w = dot(cb2[91].xyzw, r3.xyzw);
  r11.z = dot(r3.xyzw, r12.xyzw);
  r11.xyz = max(float3(0.0625,0.0625,0.0625), r11.xyz);
  r2.w = r3.y * 0.5 + 0.5;
  r12.xyz = -cb3[10].xyz + cb3[4].xyz;
  r12.xyz = r2.www * r12.xyz + cb3[10].xyz;
  r11.xyz = cb2[79].xxx * r11.xyz + r12.xyz;
  r8.xyw = cb3[0].xyz * r8.yyy;
  r12.xyz = cb3[1].xyz * r8.zzz;
  r13.xyz = r8.xyw * r4.www + r12.xyz;
  r13.xyz = r13.xyz + r11.xyz;
  r13.xyz = r13.xyz + r7.yzw;
  r5.xyz = r9.xyz * r5.xyz + r10.xyz;
  r14.xyz = int3(0x8000,16,4) & asint(cb13[0].xxx);
  r2.xyz = r2.xyz * r1.www + float3(1,1,1);
  r2.xyz = saturate(float3(0.5,0.5,0.5) * r2.xyz);
  r2.xyz = cb9[11].yyy * r2.xyz;
  r2.xyz = cb9[11].xxx * r0.xyz + r2.xyz;
  r15.xyz = cb9[11].zzz * r1.xyz;
  r2.xyz = r15.xyz * r9.xyz + r2.xyz;
  r2.xyz = cb9[11].www * r5.xxx + r2.xyz;
  r2.xyz = cb9[12].xxx * r6.zzz + r2.xyz;
  r2.xyz = cb9[12].yyy * r6.www + r2.xyz;
  r6.xyz = cb6[0].xyz * cb7[9].xyz;
  r2.xyz = cb9[13].xxx * r6.xyz + r2.xyz;
  r2.xyz = cb9[13].yyy * r9.xyz + r2.xyz;
  ...
  r2.xyz = cb9[13].zzz * r1.www + r2.xyz;
  r2.xyz = cb9[13].www * r11.xyz + r2.xyz;
  r3.xyz = cb9[14].yyy * r6.xyz;
  r2.xyz = r3.xyz * r8.xyw + r2.xyz;
  r3.xyz = cb9[14].zzz * r6.xyz;
  r2.xyz = r3.xyz * r12.xyz + r2.xyz;
  r2.xyz = cb9[14].www * r7.yzw + r2.xyz;
