  ...
  out float4 o0 : SV_Target0)
{
  ...
  r3.y = r5.x * r5.y;
  r5.xzw = r3.yyy * r8.xyz + cb3[5].xyz;
  ...
  r3.x = saturate(dot(r2.yzw, -cb3[7].xyz));
  ...
  r17.xyz = v5.xyz * r3.zzz + cb3[6].xyz;
  r3.y = dot(r17.xyz, r17.xyz);
  r3.y = rsqrt(r3.y);
  r17.xyz = r17.xyz * r3.yyy;
  r3.y = saturate(dot(-r17.xyz, r2.yzw));
  r17.xyz = v5.xyz * r3.zzz + float3(0,-0.300000012,0);
  r3.z = dot(r17.xyz, r17.xyz);
  r3.z = rsqrt(r3.z);
  r17.xyz = r17.xyz * r3.zzz;
  r3.z = saturate(dot(-r17.xyz, r2.yzw));
  r17.x = log2(r3.y);
  r17.y = log2(r3.z);
  ...
  r3.xyw = r18.xyz * r3.xxx;
  r3.xyw = r17.xyz * r5.xzw + r3.xyw;
  r19.xyz = cb6[1].xyz * cb7[10].xyz;
  r3.xyw = r19.xyz * r3.xyw;
  r20.xyz = r13.xyz * r3.zzz;
  r20.xyz = r20.xyz * r8.xyz;
  r3.xyw = r3.xyw * r7.xyw + r20.xyz;
  r10.xyz = r10.xyz * r5.yyy + r9.xyz;
  r20.xyz = r10.www * r5.yyy + r3.xyw;
  r9.xyz = r6.www ? r10.xyz : r9.xyz;
  r3.xyw = r6.www ? r20.xyz : r3.xyw;
