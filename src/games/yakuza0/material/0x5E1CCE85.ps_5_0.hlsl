  ...
  out float4 o0 : SV_Target0)
{
  ...
  r5.x = r5.x * r5.y;
  r7.xyw = r5.xxx * r8.xyz + cb3[5].xyz;
  r8.xyz = v2.xyz * r7.zzz;
  r10.xyz = r7.xyw * cb1[11].xxx + cb1[11].yyy;
  r5.x = cb1[11].z + cb1[11].w;
  ...
  r13.xyz = r9.xyz * r5.yyy + v6.xyz;
  r14.xyz = r9.www * r5.yyy + v7.xyz;
  r13.xyz = r6.www ? v6.xyz : r13.xyz;
  r14.xyz = r6.www ? v7.xyz : r14.xyz;
  r5.x = saturate(dot(r3.xyz, -cb3[7].xyz));
  r6.y = saturate(r4.w);
  r15.xyz = cb3[0].xyz * r6.yyy;
  r16.xyz = cb3[1].xyz * r5.xxx;
  ...
  r18.xyz = v5.xyz * r3.www + cb3[6].xyz;
  r6.y = dot(r18.xyz, r18.xyz);
  r6.y = rsqrt(r6.y);
  r18.xyz = r18.xyz * r6.yyy;
  r6.y = saturate(dot(-r18.xyz, r3.xyz));
  r18.xyz = v5.xyz * r3.www + float3(0,-0.300000012,0);
  r3.w = dot(r18.xyz, r18.xyz);
  r3.w = rsqrt(r3.w);
  r18.xyz = r18.xyz * r3.www;
  r3.w = saturate(dot(-r18.xyz, r3.xyz));
  r18.x = log2(r6.y);
  r18.y = log2(r3.w);
  ...
  r2.xyz = cb9[11].zzz * r1.xyz;
  r0.xyz = r2.xyz * r21.xyz + r0.xyz;
  ...
  r2.xyz = cb9[15].xxx * r21.xyz;
  r0.xyz = r2.xyz * r18.xyz + r0.xyz;
  r2.xyz = cb9[15].yyy * r21.xyz;
  r2.xyz = r2.xyz * r19.xyz;
  r0.xyz = r2.xyz * r6.zzz + r0.xyz;
  r2.xyz = cb9[15].zzz * r14.xyz;
  r0.xyz = r2.xyz * r6.zzz + r0.xyz;
  r0.xyz = r20.yyy ? r0.xyz : r9.xyz;
  r2.xyz = r20.yyy ? float3(0,0,0) : r11.xyz;
