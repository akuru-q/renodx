  ...
  out float4 o0 : SV_Target0)
{
  ...
  r5.xyz = t2.Sample(s2_s, v1.xy).xyz;
  ...
  r4.xyz = r1.www * r3.xyz + cb3[5].xyz;
  ...
  r4.xyz = r4.xyz * cb1[11].zzz + cb1[11].www;
  r4.xyz = r10.xyz * r4.xyz;
  r4.xyz = r6.zzz ? r4.xyz : r9.xyz;
  ...
  r10.xyz = v6.xyz * r4.xyz;
  r10.xyz = r10.xyz * r1.zzz;
  r9.xyz = r9.xyz * r7.xyz + r10.xyz;
  r10.xyz = v5.xyz * r2.www + cb3[6].xyz;
  r2.w = dot(r10.xyz, r10.xyz);
  r2.w = rsqrt(r2.w);
  r10.xyz = r10.xyz * r2.www;
  r2.w = saturate(dot(-r10.xyz, r1.xyw));
  r1.x = saturate(dot(-r5.xyz, r1.xyw));
  r5.x = log2(r2.w);
  r5.y = log2(r1.x);
  r1.xy = cb7[10].ww * r5.xy;
  r1.xy = exp2(r1.xy);
  r5.xyz = cb3[0].xyz * r1.xxx;
  r10.xyz = cb3[1].xyz * r1.yyy;
  r10.xyz = r10.xyz * r4.www;
  r3.xyz = r5.xyz * r3.xyz + r10.xyz;
