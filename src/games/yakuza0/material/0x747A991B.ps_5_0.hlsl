  ...
  out float4 o0 : SV_Target0)
{
  ...
  r3.xyz = r1.zzz * r2.xyz + cb3[5].xyz;
  ...
  r1.z = saturate(dot(-r10.xyz, r4.xyz));
  r1.w = saturate(dot(-r5.xyz, r4.xyz));
  r4.x = log2(r1.z);
  r4.y = log2(r1.w);
  r1.zw = cb7[10].ww * r4.xy;
  r1.zw = exp2(r1.zw);
  r4.xyz = cb3[0].xyz * r1.zzz;
