  ...
  out float4 o0 : SV_Target0)
{
  ...
  r7.w = dot(-r4.xyz, r9.xyz);
  r7.w = v2.w * r7.w;
  r10.z = r7.w * 0.200000003 + 0.5;
  r7.w = t7.Sample(s7_s, r10.xz).x;
  r3.x = r7.w * r3.x;
  r10.x = dot(r2.xyz, -r7.xyz);
  r7.w = dot(-r7.xyz, r8.xyz);
  r7.w = v2.z * r7.w;
  r10.y = r7.w * 0.200000003 + 0.5;
  r7.w = t7.Sample(s7_s, r10.xy).x;
  r8.x = dot(-r7.xyz, r9.xyz);
  r8.x = v2.w * r8.x;
  r10.z = r8.x * 0.200000003 + 0.5;
  r8.x = t7.Sample(s7_s, r10.xz).x;
  r7.w = r8.x * r7.w;
  r8.x = log2(r3.x);
  r8.y = log2(r7.w);
  ...
  r9.xyz = r5.xxx * r9.xyz + cb3[10].xyz;
  r8.xyz = cb2[79].xxx * r8.xyz + r9.xyz;
  r9.xyz = cb3[0].xyz * r2.www;
  r10.xyz = cb3[1].xyz * r3.xxx;
  r11.xyz = r9.xyz * r4.www + r10.xyz;
