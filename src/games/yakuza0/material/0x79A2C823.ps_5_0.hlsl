  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.xy = float2(0.5,0.5) + -r1.zw;
  r1.zw = r3.ww * r2.xy + r1.zw;
  r1.zw = r1.zw * float2(2,2) + float2(-1,-1);
  r2.x = dot(r1.zw, r1.zw);
  r2.x = 1 + -r2.x;
  r2.x = max(0, r2.x);
  r2.x = sqrt(r2.x);
  r2.y = r4.y * cb1[10].x + cb1[10].y;
  r2.y = r4.x * r2.y;
  r3.xyz = -cb3[5].xyz + float3(1,1,1);
  r2.yzw = r2.yyy * r3.xyz + cb3[5].xyz;
  r4.yzw = v8.yzx * v4.zxy;
  r4.yzw = v4.yzx * v8.zxy + -r4.yzw;
  r4.yzw = v8.www * r4.yzw;
  r5.xyz = v8.xyz * r1.zzz;
  r4.yzw = r1.www * r4.yzw + r5.xyz;
  r4.yzw = r2.xxx * v4.xyz + r4.yzw;
  ...
  r7.xyw = v2.xyz * r2.yzw;
  r7.xyz = r7.xyw * r7.zzz;
  r9.xyz = r3.xyz * r2.yzw;
  r10.xyz = r3.xyz * cb1[11].xxx + cb1[11].yyy;
  r2.xyz = r2.yzw * cb1[11].zzz + cb1[11].www;
  r2.xyz = r10.xyz * r2.xyz;
  r2.xyz = r6.zzz ? r2.xyz : r9.xyz;
  r1.w = saturate(dot(r4.yzw, -cb3[6].xyz));
  r2.w = saturate(dot(r4.yzw, -cb3[7].xyz));
  ...
  r10.xyz = v6.xyz * r2.xyz;
  r10.xyz = r10.xyz * r4.xxx;
  r9.xyz = r9.xyz * r7.xyz + r10.xyz;
  r10.xyz = v5.xyz * r1.zzz + cb3[6].xyz;
  r1.z = dot(r10.xyz, r10.xyz);
  r1.z = rsqrt(r1.z);
  r10.xyz = r10.xyz * r1.zzz;
  r1.z = saturate(dot(-r10.xyz, r4.yzw));
  r1.w = saturate(dot(-r5.xyz, r4.yzw));
  r5.x = log2(r1.z);
  r5.y = log2(r1.w);
  r1.zw = cb7[10].ww * r5.xy;
  r1.zw = exp2(r1.zw);
  r4.yzw = cb3[0].xyz * r1.zzz;
  r5.xyz = cb3[1].xyz * r1.www;
  r5.xyz = r5.xyz * r2.www;
  r3.xyz = r4.yzw * r3.xyz + r5.xyz;
  r4.yzw = cb6[1].xyz * cb7[10].xyz;
  r3.xyz = r4.yzw * r3.xyz;
  r4.yzw = v7.xyz * r1.www;
