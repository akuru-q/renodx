  ...
  out float4 o0 : SV_Target0)
{
  ...
  r3.y = r3.y * r3.w;
  r7.xyw = r3.yyy * r8.xyz + cb3[5].xyz;
  ...
  r14.xyz = r10.xyz * r3.www + v6.xyz;
  r15.xyz = r10.www * r3.www + v7.xyz;
  r14.xyz = r6.www ? v6.xyz : r14.xyz;
  r15.xyz = r6.www ? v7.xyz : r15.xyz;
  r3.y = saturate(dot(r2.xyz, -cb3[7].xyz));
  r4.w = saturate(r3.z);
  r16.xyz = cb3[0].xyz * r4.www;
  r17.xyz = cb3[1].xyz * r3.yyy;
  r18.xyz = cb6[0].xyz * cb7[9].xyz;
  r19.xyz = r17.xyz * r3.www;
  ...
  r7.xyz = cb9[14].yyy * r18.xyz;
  r0.xyz = r7.xyz * r16.xyz + r0.xyz;
  r7.xyz = cb9[14].zzz * r18.xyz;
  r0.xyz = r7.xyz * r17.xyz + r0.xyz;
  r0.xyz = cb9[14].www * r14.xyz + r0.xyz;
  r7.xyz = cb9[15].xxx * r22.xyz;
  r0.xyz = r7.xyz * r19.xyz + r0.xyz;
  r7.xyz = cb9[15].yyy * r22.xyz;
  r7.xyz = r7.xyz * r20.xyz;
  r0.xyz = r7.xyz * r5.yyy + r0.xyz;
  r7.xyz = cb9[15].zzz * r15.xyz;
  r0.xyz = r7.xyz * r5.yyy + r0.xyz;
  r0.xyz = r12.yyy ? r0.xyz : r10.xyz;
  r6.yzw = r12.yyy ? float3(0,0,0) : r6.yzw;
  r0.xyz = r6.yzw + r0.xyz;
  r1.x = v4.w * r1.x;
  r3.xyw = r9.xyz * r3.xxx;
  r6.yzw = cb7[6].xxx * v8.xyz;
  r7.xyzw = t12.Sample(s12_s, r6.yzw).xyzw;
  r7.xyzw = r7.xyzw * float4(2,2,2,2) + float4(-1,-1,-1,-1);
  r6.yzw = r7.xyz + -r7.www;
  r2.xyz = r6.yzw * cb7[6].yyy + r2.xyz;
  r1.y = dot(r2.xyz, r2.xyz);
  r1.y = rsqrt(r1.y);
  r2.xyz = r2.xyz * r1.yyy;
  r1.y = dot(r4.xyz, r2.xyz);
  r1.y = r1.y + r1.y;
  r2.xyz = r2.xyz * -r1.yyy + r4.xyz;
  r2.xyz = float3(-1,1,1) * r2.xyz;
  r2.xyzw = t6.Sample(s6_s, r2.xyz).xyzw;
  r1.y = r5.z * r5.w;
  r1.w = saturate(0.75 + r3.z);
  r1.y = r1.y * r1.w;
