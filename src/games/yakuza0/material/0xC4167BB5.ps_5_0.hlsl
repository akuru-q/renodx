  ...
  out float4 o0 : SV_Target0)
{
  ...
  r11.xyzw = float4(4,4,4,4) * r8.xyzw;
  r12.xyzw = int4(8192,64,0x8000,16) & asint(cb13[0].xxxx);
  r13.xyzw = r8.xyzw + r8.xyzw;
  r8.xyzw = r8.xyzw / cb1[0].zzzz;
  r8.xyzw = r12.xxxx ? r13.xyzw : r8.xyzw;
  r8.xyzw = r7.wwww ? r11.xyzw : r8.xyzw;
  r7.xzw = r10.xyz + r8.xyz;
  ...
  r2.x = 1 + -r0.y;
  r0.z = r0.z * r2.x + r0.y;
  r5.xyz = r11.xyz * r0.zzz;
  r5.xyz = r12.yyy ? r5.xyz : r13.xyz;
  r4.xyz = r6.xyz * r4.yzw + r8.xyz;
  ...
  r0.yzw = r3.xyz * r4.xyz + r0.yzw;
  r0.yzw = saturate(cb9[15].zzz * r8.xyz + r0.yzw);
