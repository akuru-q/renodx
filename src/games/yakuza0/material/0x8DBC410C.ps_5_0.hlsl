  ...
  out float4 o0 : SV_Target0)
{
  ...
  r4.w = -1 + r4.w;
  r5.w = cmp(r4.w < 0);
  r9.xy = r5.ww ? float2(1,30) : 0;
  r10.xyzw = cb2[1].xyzw * r9.xxxx;
  r10.xyzw = cb2[0].xyzw * r5.xxxx + r10.xyzw;
  r4.w = r9.y + r4.w;
  r4.w = -1 + r4.w;
  r5.x = cmp(r4.w < 0);
  r5.xw = r5.xx ? float2(1,30) : 0;
  r9.xyzw = cb2[2].xyzw * r5.xxxx + r10.xyzw;
  r4.w = r5.w + r4.w;
  r4.w = -1 + r4.w;
  r5.x = cmp(r4.w < 0);
  r5.xw = r5.xx ? float2(1,30) : 0;
  r9.xyzw = cb2[3].xyzw * r5.xxxx + r9.xyzw;
  r4.w = r5.w + r4.w;
  r4.w = -1 + r4.w;
  r5.x = cmp(r4.w < 0);
  r5.xw = r5.xx ? float2(1,30) : 0;
  r9.xyzw = cb2[4].xyzw * r5.xxxx + r9.xyzw;
  r4.w = r5.w + r4.w;
  r4.w = -1 + r4.w;
  r5.x = cmp(r4.w < 0);
  r5.xw = r5.xx ? float2(1,30) : 0;
  r9.xyzw = cb2[5].xyzw * r5.xxxx + r9.xyzw;
  r4.w = r5.w + r4.w;
  r4.w = -1 + r4.w;
  r5.x = cmp(r4.w < 0);
  r5.xw = r5.xx ? float2(1,30) : 0;
  r9.xyzw = cb2[6].xyzw * r5.xxxx + r9.xyzw;
  r4.w = r5.w + r4.w;
  r4.w = -1 + r4.w;
  r5.x = cmp(r4.w < 0);
  r5.xw = r5.xx ? float2(1,30) : 0;
  r9.xyzw = cb2[7].xyzw * r5.xxxx + r9.xyzw;
  r4.w = r5.w + r4.w;
  r4.w = -1 + r4.w;
  r5.x = cmp(r4.w < 0);
  r5.xw = r5.xx ? float2(1,30) : 0;
  r9.xyzw = cb2[8].xyzw * r5.xxxx + r9.xyzw;
  r4.w = r5.w + r4.w;
  r4.w = -1 + r4.w;
  r4.w = cmp(r4.w < 0);
  r4.w = r4.w ? 1.000000 : 0;
  r9.xyzw = cb2[9].xyzw * r4.wwww + r9.xyzw;
  r4.w = max(r0.x, r0.y);
  r4.w = max(r4.w, r0.z);
  r0.x = min(r0.x, r0.y);
  r0.x = min(r0.x, r0.z);
  ...
  if (r4.w != 0) {
    r4.w = cmp(r0.z < 0.5);
    r10.xyz = float3(1,0.333333343,-0.333333343) + r9.yxx;
    r5.x = r10.x * r0.z;
    r5.w = r0.z + r9.y;
    r5.w = -r9.y * r0.z + r5.w;
    r4.w = r4.w ? r5.x : r5.w;
    ...
    r5.w = -r5.x + r4.w;
    r6.x = 6 * r5.w;
    r10.xy = r6.xx * r9.yz + r5.xx;
    r11.xyzw = cmp(r9.yyyz < float4(0.166666672,0.5,0.666666687,0.166666672));
    r10.zw = float2(0.666666687,0.666666687) + -r9.yz;
    r10.zw = r10.zw * r5.ww;
    r10.zw = r10.zw * float2(6,6) + r5.xx;
    r7.x = r11.z ? r10.z : r5.x;
    r7.x = r11.y ? r4.w : r7.x;
    r0.x = r11.x ? r10.x : r7.x;
    r7.x = frac(r9.x);
    r6.x = r6.x * r7.x + r5.x;
    ...
    r9.xy = cmp(r9.zz < float2(0.5,0.666666687));
    r5.x = r9.y ? r10.w : r5.x;
    r4.w = r9.x ? r4.w : r5.x;
    r0.z = r11.w ? r10.y : r4.w;
  }
  ...
  r9.xyz = r3.yyy * r9.xyz + cb3[10].xyz;
  r3.xyz = r9.xyz + r3.xzw;
  r5.xyw = cb3[0].xyz * r5.yyy;
  r9.xyz = cb3[1].xyz * r5.zzz;
  r10.xyz = r5.xyw * r1.www + r9.xyz;
  r10.xyz = r10.xyz + r3.xyz;
  r10.xyz = saturate(r10.xyz + r2.xyw);
  ...
  r11.xyz = cb9[11].zzz * r1.xyz;
  r6.xyz = r11.xyz * r8.xyz + r6.xyz;
  r6.xyz = cb9[11].www * r4.xxx + r6.xyz;
  r6.xyz = cb9[12].xxx * r1.www + r6.xyz;
  r6.xyz = cb9[12].yyy + r6.xyz;
  r11.xyz = cb6[0].xyz * cb7[9].xyz;
  r6.xyz = cb9[13].xxx * r11.xyz + r6.xyz;
  ...
  r6.xyz = cb9[14].yyy * r11.xyz;
  r3.xyz = r6.xyz * r5.xyw + r3.xyz;
  r5.xyz = cb9[14].zzz * r11.xyz;
  ...
  r0.xyz = r0.xyz * r11.xyz + r1.xyz;
  r0.xyz = r13.yyy ? r2.xyz : r0.xyz;
