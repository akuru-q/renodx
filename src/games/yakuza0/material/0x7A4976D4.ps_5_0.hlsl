  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.x = saturate(dot(r3.xyz, -cb3[7].xyz));
  r14.xyz = cb3[0].xyz * r2.www;
  r15.xyz = cb3[1].xyz * r2.xxx;
  ...
  r17.xyz = v4.xyz * r2.zzz + cb3[6].xyz;
  r2.y = dot(r17.xyz, r17.xyz);
  r2.y = rsqrt(r2.y);
  r17.xyz = r17.xyz * r2.yyy;
  r2.y = saturate(dot(-r17.xyz, r3.xyz));
  r17.xyz = v4.xyz * r2.zzz + float3(0,-0.300000012,0);
  ...
  r17.x = log2(r2.y);
  r17.y = log2(r2.z);
  r2.yz = cb7[10].ww * r17.xy;
  r2.yz = exp2(r2.yz);
  r2.w = cb3[11].x + cb3[11].x;
  r17.xyz = cb3[0].xyz * r2.yyy;
  r18.xyz = cb3[1].xyz * r2.zzz;
  r18.xyz = r18.xyz * r2.www;
  r2.xyw = r18.xyz * r2.xxx;
  r2.xyw = r17.xyz * r5.xzw + r2.xyw;
  r19.xyz = cb6[1].xyz * cb7[10].xyz;
  r2.xyw = r19.xyz * r2.xyw;
  r20.xyz = r13.xyz * r2.zzz;
  r20.xyz = r20.xyz * r8.xyz;
  r2.xyw = r2.xyw * r7.xyw + r20.xyz;
  r10.xyz = r10.xyz * r5.yyy + r9.xyz;
  r20.xyz = r10.www * r5.yyy + r2.xyw;
  r9.xyz = r6.www ? r10.xyz : r9.xyz;
  r2.xyw = r6.www ? r20.xyz : r2.xyw;
  r10.xyzw = int4(128,0x8000,16,4) & asint(cb13[0].xxxx);
  r2.xyw = r10.xxx ? float3(0,0,0) : r2.xyw;
  r6.yzw = r9.xyz * r0.xyz;
  r2.xyw = r2.xyw * r1.xyz;
  r9.xyz = v3.xyz * r1.www + float3(1,1,1);
  ...
  r1.xyz = r10.yyy ? float3(0,0,0) : r2.xyw;
