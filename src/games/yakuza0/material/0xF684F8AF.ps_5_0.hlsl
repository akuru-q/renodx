  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xy = t5.Sample(s5_s, v0.zw).xy;
  r2.xyz = t2.Sample(s2_s, v1.xy).xyz;
  ...
  r1.x = rsqrt(r1.x);
  r5.xyz = v5.xyz * r1.xxx;
  r1.y = saturate(dot(r4.xyz, -cb3[6].xyz));
  ...
  r18.xyz = v5.xyz * r1.xxx + cb3[6].xyz;
  r1.y = dot(r18.xyz, r18.xyz);
  r1.y = rsqrt(r1.y);
  r18.xyz = r18.xyz * r1.yyy;
  r1.y = saturate(dot(-r18.xyz, r4.xyz));
  r18.xyz = v5.xyz * r1.xxx + float3(0,-0.300000012,0);
  r1.x = dot(r18.xyz, r18.xyz);
  r1.x = rsqrt(r1.x);
  r18.xyz = r18.xyz * r1.xxx;
  r1.x = saturate(dot(-r18.xyz, r4.xyz));
  r18.x = log2(r1.y);
  r18.y = log2(r1.x);
  r1.xy = cb7[10].ww * r18.xy;
  r1.xy = exp2(r1.xy);
  r1.w = cb3[11].x + cb3[11].x;
  r18.xyz = cb3[0].xyz * r1.xxx;
  r19.xyz = cb3[1].xyz * r1.yyy;
  r19.xyz = r19.xyz * r1.www;
  r1.xzw = r19.xyz * r1.zzz;
  r1.xzw = r18.xyz * r6.xzw + r1.xzw;
  r20.xyz = cb6[1].xyz * cb7[10].xyz;
  r1.xzw = r20.xyz * r1.xzw;
  r21.xyz = r14.xyz * r1.yyy;
  r21.xyz = r21.xyz * r9.xyz;
  r1.xzw = r1.xzw * r8.xyw + r21.xyz;
  r11.xyz = r11.xyz * r6.yyy + r10.xyz;
  r21.xyz = r11.www * r6.yyy + r1.xzw;
  r10.xyz = r7.www ? r11.xyz : r10.xyz;
  r1.xzw = r7.www ? r21.xyz : r1.xzw;
  r11.xyzw = int4(128,0x8000,16,4) & asint(cb13[0].xxxx);
  r1.xzw = r11.xxx ? float3(0,0,0) : r1.xzw;
  ...
  r2.xyz = cb9[14].yyy * r17.xyz;
  r0.xyz = r2.xyz * r15.xyz + r0.xyz;
  r2.xyz = cb9[14].zzz * r17.xyz;
  r0.xyz = r2.xyz * r16.xyz + r0.xyz;
  ...
  r2.xyz = cb9[15].zzz * r14.xyz;
  r0.xyz = r2.xyz * r1.yyy + r0.xyz;
  r0.xyz = r11.yyy ? r0.xyz : r7.yzw;
  r1.xyz = r11.yyy ? float3(0,0,0) : r1.xzw;
