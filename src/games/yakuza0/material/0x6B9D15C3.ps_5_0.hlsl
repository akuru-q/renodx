  ...
  out float4 o0 : SV_Target0)
{
  ...
  r12.xyzw = t14.Sample(s14_s, r8.xy).xyzw;
  ...
  r11.xyz = r0.yyy * r11.xyz + cb3[10].xyz;
  ...
  r3.w = cb9[12].y * r8.w;
  r3.xyz = cb9[12].xxx * r8.zzz + r3.xyz;
  r3.xyz = r3.www * r0.xxx + r3.xyz;
  r8.xyz = cb6[0].xyz * cb7[9].xyz;
  r3.xyz = cb9[13].xxx * r8.xyz + r3.xyz;
  r3.xyz = cb9[13].yyy * r6.xyz + r3.xyz;
  r0.x = r2.w * r2.w;
  r0.x = r0.x * r0.x;
  r0.x = r0.x * r2.w;
  ...
  r3.xyz = r4.xyz * r5.xyw + r3.xyz;
  r3.xyz = cb9[14].www * r7.xzw + r3.xyz;
  r4.xyz = cb9[15].xxx * r6.xyz;
  r3.xyz = r4.xyz * r9.xyz + r3.xyz;
  r4.xyz = cb9[15].yyy * r6.xyz;
  r3.xyz = r4.xyz * r9.xyz + r3.xyz;
  r3.xyz = saturate(cb9[15].zzz * r10.xyz + r3.xyz);
