  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.y = saturate(dot(r4.xyz, -cb3[6].xyz));
  ...
  r2.w = r6.x * r6.y;
  r6.xzw = r2.www * r9.xyz + cb3[5].xyz;
  ...
  r2.z = saturate(dot(r4.xyz, -cb3[7].xyz));
  r15.xyz = cb3[0].xyz * r2.yyy;
  r16.xyz = cb3[1].xyz * r2.zzz;
  ...
  r18.xyz = v5.xyz * r2.xxx + cb3[6].xyz;
  r2.y = dot(r18.xyz, r18.xyz);
  r2.y = rsqrt(r2.y);
  r18.xyz = r18.xyz * r2.yyy;
  r2.y = saturate(dot(-r18.xyz, r4.xyz));
  r18.xyz = v5.xyz * r2.xxx + float3(0,-0.300000012,0);
  r2.x = dot(r18.xyz, r18.xyz);
  r2.x = rsqrt(r2.x);
  r18.xyz = r18.xyz * r2.xxx;
  r2.x = saturate(dot(-r18.xyz, r4.xyz));
  r18.x = log2(r2.y);
  r18.y = log2(r2.x);
  r2.xy = cb7[10].ww * r18.xy;
  r2.xy = exp2(r2.xy);
  r2.w = cb3[11].x + cb3[11].x;
  r18.xyz = cb3[0].xyz * r2.xxx;
  r19.xyz = cb3[1].xyz * r2.yyy;
  r19.xyz = r19.xyz * r2.www;
  r2.xzw = r19.xyz * r2.zzz;
  r2.xzw = r18.xyz * r6.xzw + r2.xzw;
  r20.xyz = cb6[1].xyz * cb7[10].xyz;
  r2.xzw = r20.xyz * r2.xzw;
  r21.xyz = r14.xyz * r2.yyy;
  r21.xyz = r21.xyz * r9.xyz;
  r2.xzw = r2.xzw * r8.xyw + r21.xyz;
  r11.xyz = r11.xyz * r6.yyy + r10.xyz;
  r21.xyz = r11.www * r6.yyy + r2.xzw;
  r10.xyz = r7.www ? r11.xyz : r10.xyz;
  r2.xzw = r7.www ? r21.xyz : r2.xzw;
  r11.xyzw = int4(128,0x8000,16,4) & asint(cb13[0].xxxx);
  r2.xzw = r11.xxx ? float3(0,0,0) : r2.xzw;
  ...
  r1.xyz = r11.yyy ? float3(0,0,0) : r2.xzw;
