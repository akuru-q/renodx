  ...
  out float4 o0 : SV_Target0)
{
  ...
  r3.w = r6.x * r6.y;
  r8.xyw = r3.www * r9.xyz + cb3[5].xyz;
  r9.xyz = v1.xyz * r8.zzz;
  ...
  r14.xyz = r10.xyz * r6.yyy + v5.xyz;
  r15.xyz = r10.www * r6.yyy + v6.xyz;
  r14.xyz = r7.www ? v5.xyz : r14.xyz;
  ...
  r19.xyz = v4.xyz * r1.www + cb3[6].xyz;
  r4.w = dot(r19.xyz, r19.xyz);
  r4.w = rsqrt(r4.w);
  r19.xyz = r19.xyz * r4.www;
  r4.w = saturate(dot(-r19.xyz, r4.xyz));
  r19.xyz = v4.xyz * r1.www + float3(0,-0.300000012,0);
