  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.xyz = -r4.xyz * r4.xyz + float3(1,1,1);
  r2.xyz = -r2.xyz * r3.www + float3(1,1,1);
  r0.xyz = r2.xyz * r0.xyz;
  r1.w = 1 + -r1.w;
  r1.w = -r1.w * r2.w + 1;
  r1.x = r1.w * r1.x;
  ...
  r2.xy = r2.ww * r2.xy + float2(0.5,0.5);
  r2.zw = cmp(r1.yz < float2(0.5,0.5));
  r3.xy = r2.xy * r1.yz;
  r3.xy = r3.xy + r3.xy;
  r1.yz = float2(1,1) + -r1.yz;
  r1.yz = r1.yz + r1.yz;
  r2.xy = float2(1,1) + -r2.xy;
  r1.yz = -r1.yz * r2.xy + float2(1,1);
  r1.yz = r2.zw ? r3.xy : r1.yz;
  r2.xy = float2(-0.5,-0.5) + r5.xy;
  r2.xy = r3.ww * r2.xy + float2(0.5,0.5);
  r2.zw = cmp(r1.yz < float2(0.5,0.5));
  r3.xy = r2.xy * r1.yz;
  r3.xy = r3.xy + r3.xy;
  r1.yz = float2(1,1) + -r1.yz;
