  ...
  out float4 o0 : SV_Target0)
{
  ...
  r5.xyz = t14.Sample(s14_s, r3.xy).xyz;
  r5.xyz = r5.xyz / cb1[0].zzz;
  r3.xy = r4.xy * cb1[9].xz + cb1[9].yw;
  r3.xy = r3.zz ? r3.xy : r4.xy;
  r1.w = r3.x * r3.y;
  r1.xyz = r1.www * r1.xyz + cb3[5].xyz;
  r4.xyz = v1.xyz * r4.zzz;
  r6.xyz = r1.xyz * cb1[11].xxx + cb1[11].yyy;
  r1.w = cb1[11].z + cb1[11].w;
  r6.xyz = r6.xyz * r1.www;
  r6.xyz = r3.zzz ? r6.xyz : r1.xyz;
  r1.w = saturate(dot(r2.xyz, -cb3[6].xyz));
  r2.x = saturate(dot(r2.xyz, -cb3[7].xyz));
  r2.yzw = cb3[0].xyz * r1.www;
  r7.xyz = cb3[1].xyz * r2.xxx;
  r8.xyz = cb6[0].xyz * cb7[9].xyz;
  r7.xyz = r7.xyz * r3.yyy;
  r1.xyz = r2.yzw * r1.xyz + r7.xyz;
  r1.xyz = r8.xyz * r1.xyz + cb1[13].xyz;
  r1.xyz = cb7[11].xyz * r0.xyz + r1.xyz;
  r2.xyz = v5.xyz * r6.xyz;
