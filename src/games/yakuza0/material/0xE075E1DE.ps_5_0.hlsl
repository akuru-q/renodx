...
void main(
  float2 v0: TEXCOORD0,
  float4 w0: TEXCOORD1,  // float w0 : TEXCOORD1,
  float4 v1 : COLOR0,
  float4 v2 : COLOR1,
  float4 v3 : TEXCOORD2,
  float4 v4 : TEXCOORD3,
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xy = r0.xy * r0.zz;
  r0.zw = v1.ww * r0.xy;
  r1.xyzw = float4(0,0,-1,-1) + w0.xzzz;
  r1.xyzw = r0.zwzw * r1.xyzw + v0.xyxy;
  r2.xyzw = t0.Sample(s0_s, r1.xy).xyzw;
  r2.xyz = r2.xyz * r2.xyz;
  r1.xyzw = t0.Sample(s0_s, r1.zw).xyzw;
  r1.xyz = r1.xyz * r1.xyz;
  r1.xyzw = -r2.xyzw + r1.xyzw;
  r1.xyzw = w0.xzzz * r1.xyzw + r2.xyzw;
  r0.xy = r0.xy * v1.ww + float2(1,1);
  r0.xy = r0.xy * r1.xy;
  r1.xy = float2(0.5,0.5) * r0.xy;
  r0.xy = cb7[4].zw * v0.xy;
  r0.xy = t5.Sample(s5_s, r0.xy).xy;
  ...
  r3.xyz = v7.xyz * r0.xxx;
  r0.xyw = r0.yyy * r2.xyz + r3.xyz;
  ...
  r18.xyz = r16.xzw * r4.xzw + r18.xyz;
  ...
  r0.xyz = cb9[11].xxx * r1.xyz + r0.xyz;
  ...
  r0.xyz = r1.xyz * float3(0.00100000005,0.00100000005,0.00100000005) + r0.xyz;
