  ...
  out float4 o0 : SV_Target0)
{
  ...
  r7.x = -0.5 + w2.x;
  r7.w = cmp(r7.x < 0);
  r9.xy = r7.ww ? float2(1,30) : 0;
  r7.x = r9.y + r7.x;
  r7.x = -1 + r7.x;
  r7.w = cmp(r7.x < 0);
  r9.yz = r7.ww ? float2(1,30) : 0;
  r10.xyzw = cb2[1].xyzw * r9.yyyy;
  r10.xyzw = cb2[0].xyzw * r9.xxxx + r10.xyzw;
  r7.x = r9.z + r7.x;
  r7.x = -1 + r7.x;
  r7.w = cmp(r7.x < 0);
  r9.xy = r7.ww ? float2(1,30) : 0;
  r10.xyzw = cb2[2].xyzw * r9.xxxx + r10.xyzw;
  r7.x = r9.y + r7.x;
  r7.x = -1 + r7.x;
  r7.w = cmp(r7.x < 0);
  r9.xy = r7.ww ? float2(1,30) : 0;
  r10.xyzw = cb2[3].xyzw * r9.xxxx + r10.xyzw;
  r7.x = r9.y + r7.x;
  r7.x = -1 + r7.x;
  r7.w = cmp(r7.x < 0);
  r9.xy = r7.ww ? float2(1,30) : 0;
  r10.xyzw = cb2[4].xyzw * r9.xxxx + r10.xyzw;
  r7.x = r9.y + r7.x;
  r7.x = -1 + r7.x;
  r7.w = cmp(r7.x < 0);
  r9.xy = r7.ww ? float2(1,30) : 0;
  r10.xyzw = cb2[5].xyzw * r9.xxxx + r10.xyzw;
  r7.x = r9.y + r7.x;
  r7.x = -1 + r7.x;
  r7.w = cmp(r7.x < 0);
  r9.xy = r7.ww ? float2(1,30) : 0;
  r10.xyzw = cb2[6].xyzw * r9.xxxx + r10.xyzw;
  r7.x = r9.y + r7.x;
  r7.x = -1 + r7.x;
  r7.w = cmp(r7.x < 0);
  r9.xy = r7.ww ? float2(1,30) : 0;
  r10.xyzw = cb2[7].xyzw * r9.xxxx + r10.xyzw;
  r7.x = r9.y + r7.x;
  r7.x = -1 + r7.x;
  r7.w = cmp(r7.x < 0);
  r9.xy = r7.ww ? float2(1,30) : 0;
  r10.xyzw = cb2[8].xyzw * r9.xxxx + r10.xyzw;
  r7.x = r9.y + r7.x;
  r7.x = -1 + r7.x;
  r7.x = cmp(r7.x < 0);
  r7.x = r7.x ? 1.000000 : 0;
  r9.xyzw = cb2[9].xyzw * r7.xxxx + r10.xyzw;
  r7.x = max(r1.x, r1.y);
  r7.x = max(r7.x, r1.z);
  r1.x = min(r1.x, r1.y);
  r1.x = min(r1.x, r1.z);
  ...
  if (r7.x != 0) {
    ...
    r8.w = r7.x + -r7.w;
    r10.x = 6 * r8.w;
    r10.yz = r10.xx * r9.yz + r7.ww;
    r11.xyzw = cmp(r9.yyyz < float4(0.166666672,0.5,0.666666687,0.166666672));
    r12.xy = float2(0.666666687,0.666666687) + -r9.yz;
    r12.xy = r12.xy * r8.ww;
    r12.xy = r12.xy * float2(6,6) + r7.ww;
    r9.y = r11.z ? r12.x : r7.w;
    r9.y = r11.y ? r7.x : r9.y;
    r1.x = r11.x ? r10.y : r9.y;
    r9.x = frac(r9.x);
    r9.y = r10.x * r9.x + r7.w;
    r10.xyw = cmp(r9.xxx < float3(0.166666672,0.5,0.666666687));
    r9.x = 0.666666687 + -r9.x;
    r8.w = r9.x * r8.w;
    r8.w = r8.w * 6 + r7.w;
    r8.w = r10.w ? r8.w : r7.w;
    r8.w = r10.y ? r7.x : r8.w;
    r1.y = r10.x ? r9.y : r8.w;
    r9.xy = cmp(r9.zz < float2(0.5,0.666666687));
    r7.w = r9.y ? r12.y : r7.w;
    r7.x = r9.x ? r7.x : r7.w;
    r1.z = r11.w ? r10.z : r7.x;
  }
