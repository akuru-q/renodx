  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xyz = r22.yyy ? float3(0,0,0) : r13.xyz;
  r0.xyz = r1.xyz + r0.xyz;
  r1.x = v4.w * r3.w;
  r1.yzw = r10.xyz * r2.zzz;
  r2.x = dot(r5.xyz, r4.xyz);
  r2.x = r2.x + r2.x;
  r2.xzw = r4.xyz * -r2.xxx + r5.xyz;
  r2.xzw = float3(-1,1,1) * r2.xzw;
  r3.xyzw = t2.Sample(s2_s, r2.xzw).xyzw;
  r2.x = r6.z * r6.w;
  r2.y = saturate(0.75 + r2.y);
  r2.x = r2.x * r2.y;
