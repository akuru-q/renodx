  ...
  out float4 o0 : SV_Target0)
{
  ...
  r3.zw = cb12[29].zw * v8.xy;
  r5.xyzw = int4(8,0x4000,8192,2048) & asint(cb13[0].xxxx);
  if (r5.x != 0) {
    r6.xyz = t13.Sample(s13_s, r3.zw).xyw;
  } else {
    r6.xyz = float3(1,1,1);
  }
  ...
  r10.xyzw = t14.Sample(s14_s, r3.zw).xyzw;
  ...
  r3.yz = r7.xy * cb1[9].xz + cb1[9].yw;
  r3.yz = r5.xx ? r3.yz : r6.xy;
  r3.y = r3.y * r3.z;
  r6.xyw = r3.yyy * r8.xyz + cb3[5].xyz;
  ...
  r14.xyz = r10.xyz * r3.zzz + v6.xyz;
  r15.xyz = r10.www * r3.zzz + v7.xyz;
  ...
  r3.w = saturate(dot(-r19.xyz, r2.xyz));
  r19.xyz = v5.xyz * r1.www + float3(0,-0.300000012,0);
  r1.w = dot(r19.xyz, r19.xyz);
  r1.w = rsqrt(r1.w);
  r19.xyz = r19.xyz * r1.www;
  r1.w = saturate(dot(-r19.xyz, r2.xyz));
  r19.x = log2(r3.w);
  r19.y = log2(r1.w);
  r5.yz = cb7[10].ww * r19.xy;
  r5.yz = exp2(r5.yz);
  r1.w = cb3[11].x + cb3[11].x;
  r19.xyz = cb3[0].xyz * r5.yyy;
  r20.xyz = cb3[1].xyz * r5.zzz;
  ...
  r23.xyz = r15.xyz * r5.zzz;
  r23.xyz = r23.xyz * r11.xyz;
  r21.xyz = r21.xyz * r8.xyz + r23.xyz;
  r10.xyz = r10.xyz * r3.zzz + r12.xyz;
  r3.yzw = r10.www * r3.zzz + r21.xyz;
  r10.xyz = r5.www ? r10.xyz : r12.xyz;
  r3.yzw = r5.www ? r3.yzw : r21.xyz;
  r12.xyzw = int4(128,0x8000,16,4) & asint(cb13[0].xxxx);
  r3.yzw = r12.xxx ? float3(0,0,0) : r3.yzw;
  r10.xyz = r10.xyz * r0.xyz;
  r3.yzw = r3.yzw * r1.yyy;
  r21.xyz = v4.xyz * r1.zzz + float3(1,1,1);
  ...
  r1.yzw = r12.yyy ? float3(0,0,0) : r3.yzw;
  r0.xyz = r1.yzw + r0.xyz;
  r1.x = v4.w * r1.x;
  r1.yzw = r9.xyz * r3.xxx;
