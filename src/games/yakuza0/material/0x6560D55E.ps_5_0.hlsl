  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.xyz = r10.xzw * r2.xyz + r11.xyz;
  r10.xzw = cb6[1].xyz * cb7[10].xyz;
  r2.xyz = r10.xzw * r2.xyz;
  r10.xyz = v6.xyz * r10.yyy;
  ...
  r0.xyz = sqrt(r0.xyz);
  r1.xyw = v2.xyz + r0.xyz;
  r3.x = saturate(v2.x);
  r3.yzw = cb1[1].xyz + -r0.xyz;
  r0.xyz = r3.xxx * r3.yzw + r0.xyz;
  r2.xyz = r5.www ? r1.xyw : r0.xyz;
  r0.x = r0.w * r1.z + -cb7[8].x;
  r0.x = cmp(r0.x < 0);
  if (r0.x != 0) discard;
