  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.w = r5.x * r5.y;
  r5.xzw = r1.www * r8.xyz + cb3[5].xyz;
  ...
  r1.z = saturate(dot(r3.xyz, -cb3[7].xyz));
  r14.xyz = cb3[0].xyz * r2.www;
  r15.xyz = cb3[1].xyz * r1.zzz;
  ...
  r17.xyz = v5.xyz * r1.yyy + cb3[6].xyz;
  r1.w = dot(r17.xyz, r17.xyz);
  r1.w = rsqrt(r1.w);
  r17.xyz = r17.xyz * r1.www;
  r1.w = saturate(dot(-r17.xyz, r3.xyz));
  r17.xyz = v5.xyz * r1.yyy + float3(0,-0.300000012,0);
  r1.y = dot(r17.xyz, r17.xyz);
  r1.y = rsqrt(r1.y);
  r17.xyz = r17.xyz * r1.yyy;
  r1.y = saturate(dot(-r17.xyz, r3.xyz));
  r17.x = log2(r1.w);
  r17.y = log2(r1.y);
  r1.yw = cb7[10].ww * r17.xy;
  r1.yw = exp2(r1.yw);
  r2.w = cb3[11].x + cb3[11].x;
  r17.xyz = cb3[0].xyz * r1.yyy;
  r18.xyz = cb3[1].xyz * r1.www;
  r18.xyz = r18.xyz * r2.www;
  r19.xyz = r18.xyz * r1.zzz;
  r19.xyz = r17.xyz * r5.xzw + r19.xyz;
  r20.xyz = cb6[1].xyz * cb7[10].xyz;
  r19.xyz = r20.xyz * r19.xyz;
  r21.xyz = r13.xyz * r1.www;
  ...
  r1.xyz = r2.xyz * r1.xxx + float3(1,1,1);
  ...
  r1.xyz = r10.yyy ? float3(0,0,0) : r6.yzw;
