  ...
  out float4 o0 : SV_Target0)
{
  ...
  r9.xyz = v5.yzx * r2.zxy;
  r9.xyz = r2.yzx * v5.zxy + -r9.xyz;
  r9.xyz = v5.www * r9.xyz;
  r10.xyz = r9.zxy * r2.yzx;
  r10.xyz = r9.yzx * r2.zxy + -r10.xyz;
  r11.x = dot(r2.xyz, -r4.xyz);
  r3.x = dot(-r4.xyz, r9.xyz);
  r3.x = v2.z * r3.x;
  r11.y = r3.x * 0.200000003 + 0.5;
  r3.x = t7.Sample(s7_s, r11.xy).x;
  r4.w = dot(-r4.xyz, r10.xyz);
  r4.w = v2.w * r4.w;
  r11.z = r4.w * 0.200000003 + 0.5;
  r4.w = t7.Sample(s7_s, r11.xz).x;
  r3.x = r4.w * r3.x;
  r11.x = dot(r2.xyz, -r8.xyz);
  ...
  r5.xyw = t14.Sample(s14_s, r5.xy).xyz;
  r9.xyz = float3(4,4,4) * r5.xyw;
  r10.xyzw = int4(8192,0x8000,16,4) & asint(cb13[0].xxxx);
  r11.xyz = r5.xyw + r5.xyw;
  r5.xyw = r5.xyw / cb1[0].zzz;
  r5.xyw = r10.xxx ? r11.xyz : r5.xyw;
  r5.xyw = r6.www ? r9.xyz : r5.xyw;
  ...
  r6.xzw = max(float3(0.0625,0.0625,0.0625), r8.xyz);
  r2.w = saturate(dot(r2.xyz, -cb3[6].xyz));
  r2.x = saturate(dot(r2.xyz, -cb3[7].xyz));
  r2.y = r2.y * 0.5 + 0.5;
  r8.xyz = -cb3[10].xyz + cb3[4].xyz;
  r8.xyz = r2.yyy * r8.xyz + cb3[10].xyz;
  r6.xzw = cb2[79].xxx * r6.xzw + r8.xyz;
  r2.yzw = cb3[0].xyz * r2.www;
  r8.xyz = cb3[1].xyz * r2.xxx;
  r9.xyz = r2.yzw * r1.xxx + r8.xyz;
  ...
  r1.xyz = cb9[13].www * r6.xzw + r1.xyz;
  r6.xzw = cb9[14].yyy * r7.xyz;
  r1.xyz = r6.xzw * r2.yzw + r1.xyz;
