  ...
  out float4 o0 : SV_Target0)
{
  ...
  r6.x = cb7[10].w * 0.0397435986 + 0.0856831968;
  r9.xy = r9.xy * r6.xx;
  ...
  r5.x = saturate(dot(r3.xyz, -v7.xyz));
  r11.x = v0.w;
  r11.y = v1.w;
  r11.z = v7.w;
