...
// ---- Created with 3Dmigoto v1.3.16 on Fri Jun 27 13:38:45 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  // in-game sliders
  // lerp between bt709 and bt709->bt2020 color (gamut expansion)
  ...
  r0.xyz = fHdrOutputGamutMappingRatio * r0.xyz + r1.xyz; // sat
  
  r1.xyz = max(float3(0,0,0), r0.xyz);
  r1.xyz = log2(r1.xyz);
  r1.xyz = fHdrOutputGamma * r1.xyz; // contrast
  r1.xyz = exp2(r1.xyz);
  r2.xyz = cmp(r0.xyz < float3(1,1,1));
  r1.xyz = r2.xyz ? r1.xyz : r0.xyz;
  r0.xyz = bIsGUIHdrGamma ? r1.xyz : r0.xyz;
  r0.w = 10000 / fHdrOutputWhiteLevel; // brightness
