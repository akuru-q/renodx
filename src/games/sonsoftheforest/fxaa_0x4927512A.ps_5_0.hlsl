...
// ---- Created with 3Dmigoto v1.3.16 on Mon Feb 24 11:14:39 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.zw = v1.xy * cb0[8].xy + cb0[8].zw;

  // r4.xyzw = saturate(r2.zwzw * float4(-0.5,-0.5,-0.166666672,-0.166666672) + r1.zwzw);
  r4.xyzw = (r2.zwzw * float4(-0.5, -0.5, -0.166666672, -0.166666672) + r1.zwzw);
  // r2.xyzw = saturate(r2.xyzw * float4(0.166666672,0.166666672,0.5,0.5) + r1.zwzw);
  r2.xyzw = (r2.xyzw * float4(0.166666672, 0.166666672, 0.5, 0.5) + r1.zwzw);
  ...
  r2.w = dot(r4.xyz, float3(0.212672904,0.715152204,0.0721750036));
  r3.z = min(r1.x, r3.y);
  r1.x = max(r1.x, r3.y);
  r1.x = max(r1.x, r1.y);
  r1.y = min(r3.z, r1.y);
  ...
  //r3.yzw = saturate(r3.yzw);
  r0.y = dot(r3.yzw, float3(0.212672904,0.715152204,0.0721750036));
  r0.z = min(r0.y, r3.x);
  r0.y = max(r0.y, r3.x);
  r0.y = max(r0.y, r1.x);
  r0.y = cmp(r0.y < r2.w);
  ...
  r1.w = dot(r0.yzw, float3(0.212672904,0.715152204,0.0721750036));
  r1.w = sqrt(r1.w);
  r1.w = cb0[5].y * -r1.w + 1;
