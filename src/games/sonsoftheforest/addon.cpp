...
renodx::mods::shader::CustomShaders custom_shaders = {
    CustomShaderEntry(0x3BD8B8FD), // tonemapper, color grading / uberpost
    CustomShaderEntry(0xE363E5C8), // uberpost without chromatic aberration
    CustomShaderEntry(0x4927512A), // fxaa
    CustomShaderEntry(0xABBEA483), // output with fxaa, dlss, fsr3, taau
    CustomShaderEntry(0x306710B9), // output with taa 
    CustomShaderEntry(0x557FCE72), // output, main menu + cutscenes
    CustomShaderEntry(0x31E8CE9F), // output, cutscene, with no CA and filmgrain
    //CustomShaderEntry(0xB8144295), // fsr1
    CustomShaderEntry(0xB9857DFB), // uberpost, fsr1
    CustomShaderEntry(0x688BB7B7), // output with fsr1
};
...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX for Sons of The Forest";
